%------------------------------------------------------------------------------
% File     : ARI553_1 : TPTP v9.3.1. Released v5.0.0.
% Domain   : Arithmetic
% Problem  : Rational: Sum 9/17 and 3/5 greater than -8/145
% Version  : Especial.
% English  :
...
% Comments :
%------------------------------------------------------------------------------
tff(rat_combined_problem_13,conjecture,
    $greater($sum(9/17,3/5),-8/145) ).
