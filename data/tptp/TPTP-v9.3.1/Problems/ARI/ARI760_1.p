%------------------------------------------------------------------------------
% File     : ARI760_1 : TPTP v9.3.1. Released v7.0.0.
...
% Refs     :
% Source   : [SMTL]
% Names    : aviation/quantified_pointer_why.p [SMTL]

% Status   : Unsatisfiable
% Rating   : 0.00 v9.3.0, 0.50 v9.1.0, 0.40 v8.2.0, 0.50 v8.1.0, 0.67 v7.3.0, 0.75 v7.1.0, 0.67 v7.0.0
% Syntax   : Number of formulae    :  346 (  21 unt; 157 typ;   0 def)
%            Number of atoms       :  747 ( 504 equ)
%            Maximal formula atoms :   22 (   3 avg)
%            Number of connectives :  578 (  20   ~;   9   |; 414   &)
%                                         (  69 <=>;  66  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   32 (   9 avg)
%            Maximal term depth    :    6 (   1 avg)
%            Number arithmetic     :  414 ( 107 atm;  37 fun;  59 num; 211 var)
%            Number of types       :    8 (   5 usr;   2 ari;   0 dat;   0 cdt)
%            Number of type conns  :  288 ( 134   >; 154   *;   0   +;   0  <<)
%            Number of predicates  :   48 (  43 usr;   0 prp; 1-5 aty)
%            Number of functors    :  121 ( 109 usr;  26 con; 0-5 aty)
%            Number of variables   :  924 ( 571   !; 353   ?; 924   :)
...
tff(left_valid_struct__Node,type,
...
tff(smtlib___Node_of_bitvector,type,
    smtlib___Node_of_bitvector: c_sorted > c_unsorted ).

tff(smtlib___Node,type,
...
tff(right_valid_struct__Node,type,
...
tff(strict_valid_root__Node,type,
    strict_valid_root__Node: ( c_sorted * $int * $int * c_sorted ) > $o ).

tff(valid_struct__Node,type,
...
tff(smtlib___Node_of_pointer_address,type,
...
tff(strict_valid_struct__Node,type,
...
tff(valid_bitvector_struct__Node,type,
...
tff(formula_132,axiom,
    int_of_tag(c_sort(tag_id(smtlib___Node),smtlib___Node_tag)) = 1 ).

tff(formula_133,axiom,
    ! [A__questionmark_xu539_450: c_unsorted] :
    ? [A__questionmark_v_0_234: c_type] :
      ( ( A__questionmark_v_0_234 = pointer(smtlib___Node) )
      & ? [A__questionmark_v_1_235: c_sorted] :
          ( ( A__questionmark_v_1_235 = c_sort(A__questionmark_v_0_234,A__questionmark_xu539_450) )
          & ( c_sort(A__questionmark_v_0_234,smtlib___Node_of_bitvector(c_sort(bitvector,bitvector_of__Node(A__questionmark_v_1_235)))) = A__questionmark_v_1_235 ) ) ) ).

tff(formula_134,axiom,
    ! [A__questionmark_pu540_451: c_unsorted] :
    ? [A__questionmark_v_0_236: c_type] :
      ( ( A__questionmark_v_0_236 = pointer(smtlib___Node) )
      & ? [A__questionmark_v_1_237: c_sorted] :
          ( ( A__questionmark_v_1_237 = c_sort(A__questionmark_v_0_236,A__questionmark_pu540_451) )
          & ( A__questionmark_v_1_237 = c_sort(A__questionmark_v_0_236,smtlib___Node_of_pointer_address(c_sort(pointer(c_unit),pointer_address(A__questionmark_v_1_237)))) ) ) ) ).

tff(formula_135,axiom,
    ? [A__questionmark_v_0_238: c_type] :
      ( ( A__questionmark_v_0_238 = tag_id(smtlib___Node) )
      & parenttag(c_sort(A__questionmark_v_0_238,smtlib___Node_tag),c_sort(A__questionmark_v_0_238,bottom_tag)) ) ).

tff(formula_136,axiom,
    ! [A__questionmark_xu542_452: c_unsorted,A__questionmark_uNodeutagutableu541_453: c_unsorted] : instanceof(c_sort(tag_table(smtlib___Node),A__questionmark_uNodeutagutableu541_453),c_sort(pointer(smtlib___Node),A__questionmark_xu542_452),c_sort(tag_id(smtlib___Node),smtlib___Node_tag)) ).
...
tff(formula_137,axiom,
    ...
    ? [A__questionmark_v_0_239: c_sorted] :
      ...
      & ( c_sort(bitvector,bitvector_of__Node(c_sort(pointer(smtlib___Node),smtlib___Node_of_bitvector(A__questionmark_v_0_239)))) = A__questionmark_v_0_239 ) ) ).
...
tff(formula_139,axiom,
    ...
    ? [A__questionmark_v_0_241: c_sorted] :
      ...
      & ( c_sort(bitvector,bitvector_of_int32(c_sort(int32,int32_of_bitvector(A__questionmark_v_0_241)))) = A__questionmark_v_0_241 ) ) ).
...
tff(formula_147,axiom,
    ! [A__questionmark_xu0_463: c_unsorted,A__questionmark_yu0_464: c_unsorted] :
    ? [A__questionmark_v_0_249: c_sorted,A__questionmark_v_1_250: c_sorted] :
      ( ( A__questionmark_v_0_249 = c_sort(int32,A__questionmark_xu0_463) )
      & ( A__questionmark_v_1_250 = c_sort(int32,A__questionmark_yu0_464) )
      & ( eq_int32(A__questionmark_v_0_249,A__questionmark_v_1_250)
      <=> ( integer_of_int32(A__questionmark_v_0_249) = integer_of_int32(A__questionmark_v_1_250) ) ) ) ).

tff(formula_148,axiom,
    ! [A__questionmark_xu0_465: c_unsorted,A__questionmark_yu0_466: c_unsorted] :
    ? [A__questionmark_v_0_251: c_sorted,A__questionmark_v_1_252: c_sorted] :
      ( ( A__questionmark_v_0_251 = c_sort(int8,A__questionmark_xu0_465) )
      & ( A__questionmark_v_1_252 = c_sort(int8,A__questionmark_yu0_466) )
      & ( eq_int8(A__questionmark_v_0_251,A__questionmark_v_1_252)
      <=> ( integer_of_int8(A__questionmark_v_0_251) = integer_of_int8(A__questionmark_v_1_252) ) ) ) ).

tff(formula_149,axiom,
    ! [A__questionmark_xu552_467: $int] :
      ( ( $lesseq($uminus(2147483648),A__questionmark_xu552_467)
        & $lesseq(A__questionmark_xu552_467,2147483647) )
     => ( integer_of_int32(c_sort(int32,int32_of_integer(A__questionmark_xu552_467))) = A__questionmark_xu552_467 ) ) ).

tff(formula_150,axiom,
    ! [A__questionmark_xu553_468: c_unsorted] :
    ? [A__questionmark_v_0_253: c_sorted] :
      ( ( A__questionmark_v_0_253 = c_sort(int32,A__questionmark_xu553_468) )
      & eq_int32(c_sort(int32,int32_of_bitvector(c_sort(bitvector,bitvector_of_int32(A__questionmark_v_0_253)))),A__questionmark_v_0_253) ) ).

tff(formula_151,axiom,
    ! [A__questionmark_xu554_469: c_unsorted] :
    ? [A__questionmark_v_0_254: $int] :
      ( ( A__questionmark_v_0_254 = integer_of_int32(c_sort(int32,A__questionmark_xu554_469)) )
      & $lesseq($uminus(2147483648),A__questionmark_v_0_254)
      & $lesseq(A__questionmark_v_0_254,2147483647) ) ).

tff(formula_152,axiom,
    ! [A__questionmark_xu555_470: $int] :
      ( ( $lesseq($uminus(128),A__questionmark_xu555_470)
        & $lesseq(A__questionmark_xu555_470,127) )
     => ( integer_of_int8(c_sort(int8,int8_of_integer(A__questionmark_xu555_470))) = A__questionmark_xu555_470 ) ) ).

tff(formula_153,axiom,
    ! [A__questionmark_xu556_471: c_unsorted] :
    ? [A__questionmark_v_0_255: c_sorted] :
      ( ( A__questionmark_v_0_255 = c_sort(int8,A__questionmark_xu556_471) )
      & eq_int8(c_sort(int8,int8_of_bitvector(c_sort(bitvector,bitvector_of_int8(A__questionmark_v_0_255)))),A__questionmark_v_0_255) ) ).

tff(formula_154,axiom,
    ! [A__questionmark_xu557_472: c_unsorted] :
    ? [A__questionmark_v_0_256: $int] :
      ( ( A__questionmark_v_0_256 = integer_of_int8(c_sort(int8,A__questionmark_xu557_472)) )
      & $lesseq($uminus(128),A__questionmark_v_0_256)
      & $lesseq(A__questionmark_v_0_256,127) ) ).

tff(formula_155,axiom,
    ! [A__questionmark_auxu1u0_473: c_unsorted,A__questionmark_auxu2u0_474: c_unsorted,A__questionmark_auxu3u0_475: c_unsorted,A__questionmark_auxu4u0_476: c_unsorted] :
    ? [A__questionmark_v_0_257: c_type] :
      ( ( A__questionmark_v_0_257 = pointer(smtlib___Node) )
      & ( reachable(c_sort(A__questionmark_v_0_257,A__questionmark_auxu1u0_473),c_sort(A__questionmark_v_0_257,A__questionmark_auxu2u0_474),c_sort(alloc_table(smtlib___Node),A__questionmark_auxu3u0_475),c_sort(memory(smtlib___Node,A__questionmark_v_0_257),A__questionmark_auxu4u0_476))
       => ( ? [A__questionmark_uNodeuxu1uallocutableuatuLu560_477: c_unsorted,A__questionmark_uNodeunextuxu1uatuLu559_478: c_unsorted,A__questionmark_xu0u558_479: c_unsorted,A__questionmark_v_2_258: c_type,A__questionmark_v_3_259: c_type,A__questionmark_v_1_260: c_sorted] :
              ( ( A__questionmark_v_2_258 = alloc_table(smtlib___Node) )
              & ( A__questionmark_v_3_259 = memory(smtlib___Node,A__questionmark_v_0_257) )
              & ( A__questionmark_v_1_260 = c_sort(A__questionmark_v_0_257,A__questionmark_xu0u558_479) )
              & ( c_sort(A__questionmark_v_0_257,A__questionmark_auxu1u0_473) = A__questionmark_v_1_260 )
              & ( c_sort(A__questionmark_v_0_257,A__questionmark_auxu2u0_474) = A__questionmark_v_1_260 )
              & ( c_sort(A__questionmark_v_2_258,A__questionmark_auxu3u0_475) = c_sort(A__questionmark_v_2_258,A__questionmark_uNodeuxu1uallocutableuatuLu560_477) )
              & ( c_sort(A__questionmark_v_3_259,A__questionmark_auxu4u0_476) = c_sort(A__questionmark_v_3_259,A__questionmark_uNodeunextuxu1uatuLu559_478) ) )
          | ? [A__questionmark_uNodeuxu1uallocutableuatuLu564_480: c_unsorted,A__questionmark_uNodeunextuxu1uatuLu563_481: c_unsorted,A__questionmark_xu1u562_482: c_unsorted,A__questionmark_yu0u561_483: c_unsorted,A__questionmark_v_8_261: c_type,A__questionmark_v_9_262: c_type] :
              ( ( A__questionmark_v_8_261 = alloc_table(smtlib___Node) )
              & ( A__questionmark_v_9_262 = memory(smtlib___Node,A__questionmark_v_0_257) )
              & ? [A__questionmark_v_4_263: c_sorted,A__questionmark_v_5_264: c_sorted,A__questionmark_v_6_265: c_sorted,A__questionmark_v_7_266: c_sorted] :
                  ( ( A__questionmark_v_4_263 = c_sort(A__questionmark_v_8_261,A__questionmark_uNodeuxu1uallocutableuatuLu564_480) )
                  & ( A__questionmark_v_5_264 = c_sort(A__questionmark_v_0_257,A__questionmark_xu1u562_482) )
                  & ( A__questionmark_v_6_265 = c_sort(A__questionmark_v_9_262,A__questionmark_uNodeunextuxu1uatuLu563_481) )
                  & ( A__questionmark_v_7_266 = c_sort(A__questionmark_v_0_257,A__questionmark_yu0u561_483) )
                  & $lesseq(offset_min(A__questionmark_v_4_263,A__questionmark_v_5_264),0)
                  & $greatereq(offset_max(A__questionmark_v_4_263,A__questionmark_v_5_264),0)
                  & reachable(c_sort(A__questionmark_v_0_257,smtlib__select(A__questionmark_v_6_265,A__questionmark_v_5_264)),A__questionmark_v_7_266,A__questionmark_v_4_263,A__questionmark_v_6_265)
                  & ( c_sort(A__questionmark_v_0_257,A__questionmark_auxu1u0_473) = A__questionmark_v_5_264 )
                  & ( c_sort(A__questionmark_v_0_257,A__questionmark_auxu2u0_474) = A__questionmark_v_7_266 )
                  & ( c_sort(A__questionmark_v_8_261,A__questionmark_auxu3u0_475) = A__questionmark_v_4_263 )
                  & ( c_sort(A__questionmark_v_9_262,A__questionmark_auxu4u0_476) = A__questionmark_v_6_265 ) ) ) ) ) ) ).

tff(formula_156,axiom,
    ! [A__questionmark_uNodeuxu1uallocutableuatuLu560_484: c_unsorted,A__questionmark_uNodeunextuxu1uatuLu559_485: c_unsorted,A__questionmark_xu0u558_486: c_unsorted] :
    ? [A__questionmark_v_1_267: c_type] :
      ( ( A__questionmark_v_1_267 = pointer(smtlib___Node) )
      & ? [A__questionmark_v_0_268: c_sorted] :
          ( ( A__questionmark_v_0_268 = c_sort(A__questionmark_v_1_267,A__questionmark_xu0u558_486) )
          & reachable(A__questionmark_v_0_268,A__questionmark_v_0_268,c_sort(alloc_table(smtlib___Node),A__questionmark_uNodeuxu1uallocutableuatuLu560_484),c_sort(memory(smtlib___Node,A__questionmark_v_1_267),A__questionmark_uNodeunextuxu1uatuLu559_485)) ) ) ).

tff(formula_157,axiom,
    ! [A__questionmark_uNodeuxu1uallocutableuatuLu564_487: c_unsorted,A__questionmark_uNodeunextuxu1uatuLu563_488: c_unsorted,A__questionmark_xu1u562_489: c_unsorted,A__questionmark_yu0u561_490: c_unsorted] :
    ? [A__questionmark_v_2_269: c_type,A__questionmark_v_0_270: c_sorted] :
      ( ( A__questionmark_v_2_269 = pointer(smtlib___Node) )
      & ( A__questionmark_v_0_270 = c_sort(alloc_table(smtlib___Node),A__questionmark_uNodeuxu1uallocutableuatuLu564_487) )
      & ? [A__questionmark_v_1_271: c_sorted,A__questionmark_v_3_272: c_sorted,A__questionmark_v_4_273: c_sorted] :
          ( ( A__questionmark_v_1_271 = c_sort(A__questionmark_v_2_269,A__questionmark_xu1u562_489) )
          & ( A__questionmark_v_3_272 = c_sort(memory(smtlib___Node,A__questionmark_v_2_269),A__questionmark_uNodeunextuxu1uatuLu563_488) )
          & ( A__questionmark_v_4_273 = c_sort(A__questionmark_v_2_269,A__questionmark_yu0u561_490) )
          & ( ( $lesseq(offset_min(A__questionmark_v_0_270,A__questionmark_v_1_271),0)
              & $greatereq(offset_max(A__questionmark_v_0_270,A__questionmark_v_1_271),0)
              & reachable(c_sort(A__questionmark_v_2_269,smtlib__select(A__questionmark_v_3_272,A__questionmark_v_1_271)),A__questionmark_v_4_273,A__questionmark_v_0_270,A__questionmark_v_3_272) )
           => reachable(A__questionmark_v_1_271,A__questionmark_v_4_273,A__questionmark_v_0_270,A__questionmark_v_3_272) ) ) ) ).

tff(formula_158,axiom,
    ! [A__questionmark_xu4u0_491: c_unsorted,A__questionmark_uNodeuxu4u5uallocutableuatuLu0_492: c_unsorted,A__questionmark_uNodeunextuxu4u5uatuLu0_493: c_unsorted] :
    ? [A__questionmark_v_0_274: c_type] :
      ( ( A__questionmark_v_0_274 = pointer(smtlib___Node) )
      & ( is_cycle(c_sort(A__questionmark_v_0_274,A__questionmark_xu4u0_491),c_sort(alloc_table(smtlib___Node),A__questionmark_uNodeuxu4u5uallocutableuatuLu0_492),c_sort(memory(smtlib___Node,A__questionmark_v_0_274),A__questionmark_uNodeunextuxu4u5uatuLu0_493))
      <=> ? [A__questionmark_yu2u565_494: c_unsorted,A__questionmark_v_3_275: c_sorted,A__questionmark_v_1_276: c_sorted,A__questionmark_v_2_277: c_sorted] :
            ( ( A__questionmark_v_3_275 = c_sort(A__questionmark_v_0_274,A__questionmark_xu4u0_491) )
            & ( A__questionmark_v_1_276 = c_sort(memory(smtlib___Node,A__questionmark_v_0_274),A__questionmark_uNodeunextuxu4u5uatuLu0_493) )
            & ( A__questionmark_v_2_277 = c_sort(A__questionmark_v_0_274,A__questionmark_yu2u565_494) )
            & reachable(A__questionmark_v_3_275,A__questionmark_v_2_277,c_sort(alloc_table(smtlib___Node),A__questionmark_uNodeuxu4u5uallocutableuatuLu0_492),A__questionmark_v_1_276)
            & ( c_sort(A__questionmark_v_0_274,smtlib__select(A__questionmark_v_1_276,A__questionmark_v_2_277)) = A__questionmark_v_3_275 ) ) ) ) ).

tff(formula_159,axiom,
    ! [A__questionmark_xu3u0_495: c_unsorted,A__questionmark_elemu0_496: $int,A__questionmark_uNodeuxu3u4uallocutableuatuLu0_497: c_unsorted,A__questionmark_uNodeunextuxu3u4uatuLu0_498: c_unsorted,A__questionmark_uNodeuelemuxu3u4uatuLu0_499: c_unsorted] :
    ? [A__questionmark_v_0_278: c_type] :
      ( ( A__questionmark_v_0_278 = pointer(smtlib___Node) )
      & ( is_in_list(c_sort(A__questionmark_v_0_278,A__questionmark_xu3u0_495),A__questionmark_elemu0_496,c_sort(alloc_table(smtlib___Node),A__questionmark_uNodeuxu3u4uallocutableuatuLu0_497),c_sort(memory(smtlib___Node,A__questionmark_v_0_278),A__questionmark_uNodeunextuxu3u4uatuLu0_498),c_sort(memory(smtlib___Node,int32),A__questionmark_uNodeuelemuxu3u4uatuLu0_499))
      <=> ? [A__questionmark_yu1u566_500: c_unsorted,A__questionmark_v_1_279: c_sorted] :
            ( ( A__questionmark_v_1_279 = c_sort(A__questionmark_v_0_278,A__questionmark_yu1u566_500) )
            & reachable(c_sort(A__questionmark_v_0_278,A__questionmark_xu3u0_495),A__questionmark_v_1_279,c_sort(alloc_table(smtlib___Node),A__questionmark_uNodeuxu3u4uallocutableuatuLu0_497),c_sort(memory(smtlib___Node,A__questionmark_v_0_278),A__questionmark_uNodeunextuxu3u4uatuLu0_498))
            & ( integer_of_int32(c_sort(int32,smtlib__select(c_sort(memory(smtlib___Node,int32),A__questionmark_uNodeuelemuxu3u4uatuLu0_499),A__questionmark_v_1_279))) = A__questionmark_elemu0_496 ) ) ) ) ).

tff(formula_160,axiom,
    ! [A__questionmark_xu2u0_501: c_unsorted,A__questionmark_uNodeuxu2u3uallocutableuatuLu0_502: c_unsorted,A__questionmark_uNodeunextuxu2u3uatuLu0_503: c_unsorted] :
    ? [A__questionmark_v_0_280: c_type] :
      ( ( A__questionmark_v_0_280 = pointer(smtlib___Node) )
      & ? [A__questionmark_v_1_281: c_sorted,A__questionmark_v_2_282: c_sorted,A__questionmark_v_3_283: c_sorted] :
          ( ( A__questionmark_v_1_281 = c_sort(A__questionmark_v_0_280,A__questionmark_xu2u0_501) )
          & ( A__questionmark_v_2_282 = c_sort(alloc_table(smtlib___Node),A__questionmark_uNodeuxu2u3uallocutableuatuLu0_502) )
          & ( A__questionmark_v_3_283 = c_sort(memory(smtlib___Node,A__questionmark_v_0_280),A__questionmark_uNodeunextuxu2u3uatuLu0_503) )
          & ( is_list(A__questionmark_v_1_281,A__questionmark_v_2_282,A__questionmark_v_3_283)
          <=> reachable(A__questionmark_v_1_281,c_sort(A__questionmark_v_0_280,null),A__questionmark_v_2_282,A__questionmark_v_3_283) ) ) ) ).

tff(formula_161,axiom,
    ! [A__questionmark_pu0_504: c_unsorted,A__questionmark_au0_505: $int,A__questionmark_uNodeuallocutableu0_506: c_unsorted] :
    ? [A__questionmark_v_1_284: c_sorted,A__questionmark_v_0_285: c_sorted] :
      ( ( A__questionmark_v_1_284 = c_sort(pointer(smtlib___Node),A__questionmark_pu0_504) )
      & ( A__questionmark_v_0_285 = c_sort(alloc_table(smtlib___Node),A__questionmark_uNodeuallocutableu0_506) )
      & ( left_valid_struct__Node(A__questionmark_v_1_284,A__questionmark_au0_505,A__questionmark_v_0_285)
      <=> $lesseq(offset_min(A__questionmark_v_0_285,A__questionmark_v_1_284),A__questionmark_au0_505) ) ) ).

tff(formula_162,axiom,
    ! [A__questionmark_pu0_507: c_unsorted,A__questionmark_au0_508: $int,A__questionmark_charuPuallocutableu0_509: c_unsorted] :
    ? [A__questionmark_v_1_286: c_sorted,A__questionmark_v_0_287: c_sorted] :
      ( ( A__questionmark_v_1_286 = c_sort(pointer(char_P),A__questionmark_pu0_507) )
      & ( A__questionmark_v_0_287 = c_sort(alloc_table(char_P),A__questionmark_charuPuallocutableu0_509) )
      & ( left_valid_struct_char_P(A__questionmark_v_1_286,A__questionmark_au0_508,A__questionmark_v_0_287)
      <=> $lesseq(offset_min(A__questionmark_v_0_287,A__questionmark_v_1_286),A__questionmark_au0_508) ) ) ).

tff(formula_163,axiom,
    ! [A__questionmark_pu0_510: c_unsorted,A__questionmark_au0_511: $int,A__questionmark_voiduPuallocutableu0_512: c_unsorted] :
    ? [A__questionmark_v_1_288: c_sorted,A__questionmark_v_0_289: c_sorted] :
      ( ( A__questionmark_v_1_288 = c_sort(pointer(void_P),A__questionmark_pu0_510) )
      & ( A__questionmark_v_0_289 = c_sort(alloc_table(void_P),A__questionmark_voiduPuallocutableu0_512) )
      & ( left_valid_struct_void_P(A__questionmark_v_1_288,A__questionmark_au0_511,A__questionmark_v_0_289)
      <=> $lesseq(offset_min(A__questionmark_v_0_289,A__questionmark_v_1_288),A__questionmark_au0_511) ) ) ).

tff(formula_164,axiom,
    ! [A__questionmark_pu567_513: c_unsorted] :
    ? [A__questionmark_v_0_290: c_type] :
      ( ( A__questionmark_v_0_290 = pointer(c_unit) )
      & ? [A__questionmark_v_1_291: c_sorted] :
          ( ( A__questionmark_v_1_291 = c_sort(A__questionmark_v_0_290,A__questionmark_pu567_513) )
          & ( A__questionmark_v_1_291 = c_sort(A__questionmark_v_0_290,pointer_address(c_sort(pointer(smtlib___Node),smtlib___Node_of_pointer_address(A__questionmark_v_1_291)))) ) ) ) ).

tff(formula_165,axiom,
    ! [A__questionmark_pu568_514: c_unsorted] :
    ? [A__questionmark_v_0_292: c_type] :
      ( ( A__questionmark_v_0_292 = pointer(c_unit) )
      & ? [A__questionmark_v_1_293: c_sorted] :
          ( ( A__questionmark_v_1_293 = c_sort(A__questionmark_v_0_292,A__questionmark_pu568_514) )
          & ( A__questionmark_v_1_293 = c_sort(A__questionmark_v_0_292,pointer_address(c_sort(pointer(char_P),char_P_of_pointer_address(A__questionmark_v_1_293)))) ) ) ) ).

tff(formula_166,axiom,
    ! [A__questionmark_pu569_515: c_unsorted] :
    ? [A__questionmark_v_0_294: c_type] :
      ( ( A__questionmark_v_0_294 = pointer(c_unit) )
      & ? [A__questionmark_v_1_295: c_sorted] :
          ( ( A__questionmark_v_1_295 = c_sort(A__questionmark_v_0_294,A__questionmark_pu569_515) )
          & ( A__questionmark_v_1_295 = c_sort(A__questionmark_v_0_294,pointer_address(c_sort(pointer(void_P),void_P_of_pointer_address(A__questionmark_v_1_295)))) ) ) ) ).

tff(formula_167,axiom,
    ! [A__questionmark_pu0_516: c_unsorted,A__questionmark_bu0_517: $int,A__questionmark_uNodeuallocutableu0_518: c_unsorted] :
    ? [A__questionmark_v_1_296: c_sorted,A__questionmark_v_0_297: c_sorted] :
      ( ( A__questionmark_v_1_296 = c_sort(pointer(smtlib___Node),A__questionmark_pu0_516) )
      & ( A__questionmark_v_0_297 = c_sort(alloc_table(smtlib___Node),A__questionmark_uNodeuallocutableu0_518) )
      & ( right_valid_struct__Node(A__questionmark_v_1_296,A__questionmark_bu0_517,A__questionmark_v_0_297)
      <=> $greatereq(offset_max(A__questionmark_v_0_297,A__questionmark_v_1_296),A__questionmark_bu0_517) ) ) ).

tff(formula_168,axiom,
    ! [A__questionmark_pu0_519: c_unsorted,A__questionmark_bu0_520: $int,A__questionmark_charuPuallocutableu0_521: c_unsorted] :
    ? [A__questionmark_v_1_298: c_sorted,A__questionmark_v_0_299: c_sorted] :
      ( ( A__questionmark_v_1_298 = c_sort(pointer(char_P),A__questionmark_pu0_519) )
      & ( A__questionmark_v_0_299 = c_sort(alloc_table(char_P),A__questionmark_charuPuallocutableu0_521) )
      & ( right_valid_struct_char_P(A__questionmark_v_1_298,A__questionmark_bu0_520,A__questionmark_v_0_299)
      <=> $greatereq(offset_max(A__questionmark_v_0_299,A__questionmark_v_1_298),A__questionmark_bu0_520) ) ) ).

tff(formula_169,axiom,
    ! [A__questionmark_pu0_522: c_unsorted,A__questionmark_bu0_523: $int,A__questionmark_voiduPuallocutableu0_524: c_unsorted] :
    ? [A__questionmark_v_1_300: c_sorted,A__questionmark_v_0_301: c_sorted] :
      ( ( A__questionmark_v_1_300 = c_sort(pointer(void_P),A__questionmark_pu0_522) )
      & ( A__questionmark_v_0_301 = c_sort(alloc_table(void_P),A__questionmark_voiduPuallocutableu0_524) )
      & ( right_valid_struct_void_P(A__questionmark_v_1_300,A__questionmark_bu0_523,A__questionmark_v_0_301)
      <=> $greatereq(offset_max(A__questionmark_v_0_301,A__questionmark_v_1_300),A__questionmark_bu0_523) ) ) ).

tff(formula_170,axiom,
    ! [A__questionmark_pu0_525: c_unsorted,A__questionmark_au0_526: $int,A__questionmark_bu0_527: $int,A__questionmark_uNodeuallocutableu0_528: c_unsorted] :
    ? [A__questionmark_v_1_302: c_sorted,A__questionmark_v_0_303: c_sorted] :
      ( ( A__questionmark_v_1_302 = c_sort(pointer(smtlib___Node),A__questionmark_pu0_525) )
      & ( A__questionmark_v_0_303 = c_sort(alloc_table(smtlib___Node),A__questionmark_uNodeuallocutableu0_528) )
      & ( strict_valid_root__Node(A__questionmark_v_1_302,A__questionmark_au0_526,A__questionmark_bu0_527,A__questionmark_v_0_303)
      <=> ( ( offset_min(A__questionmark_v_0_303,A__questionmark_v_1_302) = A__questionmark_au0_526 )
          & ( offset_max(A__questionmark_v_0_303,A__questionmark_v_1_302) = A__questionmark_bu0_527 ) ) ) ) ).

tff(formula_171,axiom,
    ! [A__questionmark_pu0_529: c_unsorted,A__questionmark_au0_530: $int,A__questionmark_bu0_531: $int,A__questionmark_charuPuallocutableu0_532: c_unsorted] :
    ? [A__questionmark_v_1_304: c_sorted,A__questionmark_v_0_305: c_sorted] :
      ( ( A__questionmark_v_1_304 = c_sort(pointer(char_P),A__questionmark_pu0_529) )
      & ( A__questionmark_v_0_305 = c_sort(alloc_table(char_P),A__questionmark_charuPuallocutableu0_532) )
      & ( strict_valid_root_char_P(A__questionmark_v_1_304,A__questionmark_au0_530,A__questionmark_bu0_531,A__questionmark_v_0_305)
      <=> ( ( offset_min(A__questionmark_v_0_305,A__questionmark_v_1_304) = A__questionmark_au0_530 )
          & ( offset_max(A__questionmark_v_0_305,A__questionmark_v_1_304) = A__questionmark_bu0_531 ) ) ) ) ).

tff(formula_172,axiom,
    ! [A__questionmark_pu0_533: c_unsorted,A__questionmark_au0_534: $int,A__questionmark_bu0_535: $int,A__questionmark_voiduPuallocutableu0_536: c_unsorted] :
    ? [A__questionmark_v_1_306: c_sorted,A__questionmark_v_0_307: c_sorted] :
      ( ( A__questionmark_v_1_306 = c_sort(pointer(void_P),A__questionmark_pu0_533) )
      & ( A__questionmark_v_0_307 = c_sort(alloc_table(void_P),A__questionmark_voiduPuallocutableu0_536) )
      & ( strict_valid_root_void_P(A__questionmark_v_1_306,A__questionmark_au0_534,A__questionmark_bu0_535,A__questionmark_v_0_307)
      <=> ( ( offset_min(A__questionmark_v_0_307,A__questionmark_v_1_306) = A__questionmark_au0_534 )
          & ( offset_max(A__questionmark_v_0_307,A__questionmark_v_1_306) = A__questionmark_bu0_535 ) ) ) ) ).

tff(formula_173,axiom,
    ! [A__questionmark_pu0_537: c_unsorted,A__questionmark_au0_538: $int,A__questionmark_bu0_539: $int,A__questionmark_uNodeuallocutableu0_540: c_unsorted] :
    ? [A__questionmark_v_1_308: c_sorted,A__questionmark_v_0_309: c_sorted] :
      ( ( A__questionmark_v_1_308 = c_sort(pointer(smtlib___Node),A__questionmark_pu0_537) )
      & ( A__questionmark_v_0_309 = c_sort(alloc_table(smtlib___Node),A__questionmark_uNodeuallocutableu0_540) )
      & ( strict_valid_struct__Node(A__questionmark_v_1_308,A__questionmark_au0_538,A__questionmark_bu0_539,A__questionmark_v_0_309)
      <=> ( ( offset_min(A__questionmark_v_0_309,A__questionmark_v_1_308) = A__questionmark_au0_538 )
          & ( offset_max(A__questionmark_v_0_309,A__questionmark_v_1_308) = A__questionmark_bu0_539 ) ) ) ) ).

tff(formula_174,axiom,
    ! [A__questionmark_pu0_541: c_unsorted,A__questionmark_au0_542: $int,A__questionmark_bu0_543: $int,A__questionmark_charuPuallocutableu0_544: c_unsorted] :
    ? [A__questionmark_v_1_310: c_sorted,A__questionmark_v_0_311: c_sorted] :
      ( ( A__questionmark_v_1_310 = c_sort(pointer(char_P),A__questionmark_pu0_541) )
      & ( A__questionmark_v_0_311 = c_sort(alloc_table(char_P),A__questionmark_charuPuallocutableu0_544) )
      & ( strict_valid_struct_char_P(A__questionmark_v_1_310,A__questionmark_au0_542,A__questionmark_bu0_543,A__questionmark_v_0_311)
      <=> ( ( offset_min(A__questionmark_v_0_311,A__questionmark_v_1_310) = A__questionmark_au0_542 )
          & ( offset_max(A__questionmark_v_0_311,A__questionmark_v_1_310) = A__questionmark_bu0_543 ) ) ) ) ).

tff(formula_175,axiom,
    ! [A__questionmark_pu0_545: c_unsorted,A__questionmark_au0_546: $int,A__questionmark_bu0_547: $int,A__questionmark_voiduPuallocutableu0_548: c_unsorted] :
    ? [A__questionmark_v_1_312: c_sorted,A__questionmark_v_0_313: c_sorted] :
      ( ( A__questionmark_v_1_312 = c_sort(pointer(void_P),A__questionmark_pu0_545) )
      & ( A__questionmark_v_0_313 = c_sort(alloc_table(void_P),A__questionmark_voiduPuallocutableu0_548) )
      & ( strict_valid_struct_void_P(A__questionmark_v_1_312,A__questionmark_au0_546,A__questionmark_bu0_547,A__questionmark_v_0_313)
      <=> ( ( offset_min(A__questionmark_v_0_313,A__questionmark_v_1_312) = A__questionmark_au0_546 )
          & ( offset_max(A__questionmark_v_0_313,A__questionmark_v_1_312) = A__questionmark_bu0_547 ) ) ) ) ).

tff(formula_176,axiom,
    ! [A__questionmark_pu0_549: c_unsorted,A__questionmark_au0_550: $int,A__questionmark_bu0_551: $int,A__questionmark_bitvectoruallocutableu0_552: c_unsorted] :
    ? [A__questionmark_v_1_314: c_sorted,A__questionmark_v_0_315: c_sorted] :
      ( ( A__questionmark_v_1_314 = c_sort(pointer(c_unit),A__questionmark_pu0_549) )
      & ( A__questionmark_v_0_315 = c_sort(alloc_table(c_unit),A__questionmark_bitvectoruallocutableu0_552) )
      & ( valid_bitvector_struct__Node(A__questionmark_v_1_314,A__questionmark_au0_550,A__questionmark_bu0_551,A__questionmark_v_0_315)
      <=> ( ( offset_min(A__questionmark_v_0_315,A__questionmark_v_1_314) = A__questionmark_au0_550 )
          & ( offset_max(A__questionmark_v_0_315,A__questionmark_v_1_314) = A__questionmark_bu0_551 ) ) ) ) ).

tff(formula_177,axiom,
    ! [A__questionmark_pu0_553: c_unsorted,A__questionmark_au0_554: $int,A__questionmark_bu0_555: $int,A__questionmark_bitvectoruallocutableu0_556: c_unsorted] :
    ? [A__questionmark_v_1_316: c_sorted,A__questionmark_v_0_317: c_sorted] :
      ( ( A__questionmark_v_1_316 = c_sort(pointer(c_unit),A__questionmark_pu0_553) )
      & ( A__questionmark_v_0_317 = c_sort(alloc_table(c_unit),A__questionmark_bitvectoruallocutableu0_556) )
      & ( valid_bitvector_struct_char_P(A__questionmark_v_1_316,A__questionmark_au0_554,A__questionmark_bu0_555,A__questionmark_v_0_317)
      <=> ( ( offset_min(A__questionmark_v_0_317,A__questionmark_v_1_316) = A__questionmark_au0_554 )
          & ( offset_max(A__questionmark_v_0_317,A__questionmark_v_1_316) = A__questionmark_bu0_555 ) ) ) ) ).

tff(formula_178,axiom,
    ! [A__questionmark_pu0_557: c_unsorted,A__questionmark_au0_558: $int,A__questionmark_bu0_559: $int,A__questionmark_bitvectoruallocutableu0_560: c_unsorted] :
    ? [A__questionmark_v_1_318: c_sorted,A__questionmark_v_0_319: c_sorted] :
      ( ( A__questionmark_v_1_318 = c_sort(pointer(c_unit),A__questionmark_pu0_557) )
      & ( A__questionmark_v_0_319 = c_sort(alloc_table(c_unit),A__questionmark_bitvectoruallocutableu0_560) )
      & ( valid_bitvector_struct_void_P(A__questionmark_v_1_318,A__questionmark_au0_558,A__questionmark_bu0_559,A__questionmark_v_0_319)
      <=> ( ( offset_min(A__questionmark_v_0_319,A__questionmark_v_1_318) = A__questionmark_au0_558 )
          & ( offset_max(A__questionmark_v_0_319,A__questionmark_v_1_318) = A__questionmark_bu0_559 ) ) ) ) ).

tff(formula_179,axiom,
    ! [A__questionmark_pu0_561: c_unsorted,A__questionmark_au0_562: $int,A__questionmark_bu0_563: $int,A__questionmark_uNodeuallocutableu0_564: c_unsorted] :
    ? [A__questionmark_v_1_320: c_sorted,A__questionmark_v_0_321: c_sorted] :
      ( ( A__questionmark_v_1_320 = c_sort(pointer(smtlib___Node),A__questionmark_pu0_561) )
      & ( A__questionmark_v_0_321 = c_sort(alloc_table(smtlib___Node),A__questionmark_uNodeuallocutableu0_564) )
      & ( valid_root__Node(A__questionmark_v_1_320,A__questionmark_au0_562,A__questionmark_bu0_563,A__questionmark_v_0_321)
      <=> ( $lesseq(offset_min(A__questionmark_v_0_321,A__questionmark_v_1_320),A__questionmark_au0_562)
          & $greatereq(offset_max(A__questionmark_v_0_321,A__questionmark_v_1_320),A__questionmark_bu0_563) ) ) ) ).

tff(formula_180,axiom,
    ! [A__questionmark_pu0_565: c_unsorted,A__questionmark_au0_566: $int,A__questionmark_bu0_567: $int,A__questionmark_charuPuallocutableu0_568: c_unsorted] :
    ? [A__questionmark_v_1_322: c_sorted,A__questionmark_v_0_323: c_sorted] :
      ( ( A__questionmark_v_1_322 = c_sort(pointer(char_P),A__questionmark_pu0_565) )
      & ( A__questionmark_v_0_323 = c_sort(alloc_table(char_P),A__questionmark_charuPuallocutableu0_568) )
      & ( valid_root_char_P(A__questionmark_v_1_322,A__questionmark_au0_566,A__questionmark_bu0_567,A__questionmark_v_0_323)
      <=> ( $lesseq(offset_min(A__questionmark_v_0_323,A__questionmark_v_1_322),A__questionmark_au0_566)
          & $greatereq(offset_max(A__questionmark_v_0_323,A__questionmark_v_1_322),A__questionmark_bu0_567) ) ) ) ).

tff(formula_181,axiom,
    ! [A__questionmark_pu0_569: c_unsorted,A__questionmark_au0_570: $int,A__questionmark_bu0_571: $int,A__questionmark_voiduPuallocutableu0_572: c_unsorted] :
    ? [A__questionmark_v_1_324: c_sorted,A__questionmark_v_0_325: c_sorted] :
      ( ( A__questionmark_v_1_324 = c_sort(pointer(void_P),A__questionmark_pu0_569) )
      & ( A__questionmark_v_0_325 = c_sort(alloc_table(void_P),A__questionmark_voiduPuallocutableu0_572) )
      & ( valid_root_void_P(A__questionmark_v_1_324,A__questionmark_au0_570,A__questionmark_bu0_571,A__questionmark_v_0_325)
      <=> ( $lesseq(offset_min(A__questionmark_v_0_325,A__questionmark_v_1_324),A__questionmark_au0_570)
          & $greatereq(offset_max(A__questionmark_v_0_325,A__questionmark_v_1_324),A__questionmark_bu0_571) ) ) ) ).

tff(formula_182,axiom,
    ! [A__questionmark_pu0_573: c_unsorted,A__questionmark_au0_574: $int,A__questionmark_bu0_575: $int,A__questionmark_uNodeuallocutableu0_576: c_unsorted] :
    ? [A__questionmark_v_1_326: c_sorted,A__questionmark_v_0_327: c_sorted] :
      ( ( A__questionmark_v_1_326 = c_sort(pointer(smtlib___Node),A__questionmark_pu0_573) )
      & ( A__questionmark_v_0_327 = c_sort(alloc_table(smtlib___Node),A__questionmark_uNodeuallocutableu0_576) )
      & ( valid_struct__Node(A__questionmark_v_1_326,A__questionmark_au0_574,A__questionmark_bu0_575,A__questionmark_v_0_327)
      <=> ( $lesseq(offset_min(A__questionmark_v_0_327,A__questionmark_v_1_326),A__questionmark_au0_574)
          & $greatereq(offset_max(A__questionmark_v_0_327,A__questionmark_v_1_326),A__questionmark_bu0_575) ) ) ) ).

tff(formula_183,axiom,
    ! [A__questionmark_pu0_577: c_unsorted,A__questionmark_au0_578: $int,A__questionmark_bu0_579: $int,A__questionmark_charuPuallocutableu0_580: c_unsorted] :
    ? [A__questionmark_v_1_328: c_sorted,A__questionmark_v_0_329: c_sorted] :
      ( ( A__questionmark_v_1_328 = c_sort(pointer(char_P),A__questionmark_pu0_577) )
      & ( A__questionmark_v_0_329 = c_sort(alloc_table(char_P),A__questionmark_charuPuallocutableu0_580) )
      & ( valid_struct_char_P(A__questionmark_v_1_328,A__questionmark_au0_578,A__questionmark_bu0_579,A__questionmark_v_0_329)
      <=> ( $lesseq(offset_min(A__questionmark_v_0_329,A__questionmark_v_1_328),A__questionmark_au0_578)
          & $greatereq(offset_max(A__questionmark_v_0_329,A__questionmark_v_1_328),A__questionmark_bu0_579) ) ) ) ).

tff(formula_184,axiom,
    ! [A__questionmark_pu0_581: c_unsorted,A__questionmark_au0_582: $int,A__questionmark_bu0_583: $int,A__questionmark_voiduPuallocutableu0_584: c_unsorted] :
    ? [A__questionmark_v_1_330: c_sorted,A__questionmark_v_0_331: c_sorted] :
      ( ( A__questionmark_v_1_330 = c_sort(pointer(void_P),A__questionmark_pu0_581) )
      & ( A__questionmark_v_0_331 = c_sort(alloc_table(void_P),A__questionmark_voiduPuallocutableu0_584) )
      & ( valid_struct_void_P(A__questionmark_v_1_330,A__questionmark_au0_582,A__questionmark_bu0_583,A__questionmark_v_0_331)
      <=> ( $lesseq(offset_min(A__questionmark_v_0_331,A__questionmark_v_1_330),A__questionmark_au0_582)
          & $greatereq(offset_max(A__questionmark_v_0_331,A__questionmark_v_1_330),A__questionmark_bu0_583) ) ) ) ).

tff(formula_185,axiom,
    int_of_tag(c_sort(tag_id(void_P),void_P_tag)) = 1 ).

tff(formula_186,axiom,
    ! [A__questionmark_xu570_585: c_unsorted] :
    ? [A__questionmark_v_0_332: c_type] :
      ( ( A__questionmark_v_0_332 = pointer(void_P) )
      & ? [A__questionmark_v_1_333: c_sorted] :
          ( ( A__questionmark_v_1_333 = c_sort(A__questionmark_v_0_332,A__questionmark_xu570_585) )
          & ( c_sort(A__questionmark_v_0_332,void_P_of_bitvector(c_sort(bitvector,bitvector_of_void_P(A__questionmark_v_1_333)))) = A__questionmark_v_1_333 ) ) ) ).

tff(formula_187,axiom,
    ! [A__questionmark_pu571_586: c_unsorted] :
    ? [A__questionmark_v_0_334: c_type] :
      ( ( A__questionmark_v_0_334 = pointer(void_P) )
      & ? [A__questionmark_v_1_335: c_sorted] :
          ( ( A__questionmark_v_1_335 = c_sort(A__questionmark_v_0_334,A__questionmark_pu571_586) )
          & ( A__questionmark_v_1_335 = c_sort(A__questionmark_v_0_334,void_P_of_pointer_address(c_sort(pointer(c_unit),pointer_address(A__questionmark_v_1_335)))) ) ) ) ).

tff(formula_188,axiom,
    ? [A__questionmark_v_0_336: c_type] :
      ( ( A__questionmark_v_0_336 = tag_id(void_P) )
      & parenttag(c_sort(A__questionmark_v_0_336,void_P_tag),c_sort(A__questionmark_v_0_336,bottom_tag)) ) ).

tff(formula_189,axiom,
    ! [A__questionmark_xu573_587: c_unsorted,A__questionmark_voiduPutagutableu572_588: c_unsorted] : instanceof(c_sort(tag_table(void_P),A__questionmark_voiduPutagutableu572_588),c_sort(pointer(void_P),A__questionmark_xu573_587),c_sort(tag_id(void_P),void_P_tag)) ).
