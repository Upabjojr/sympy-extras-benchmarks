%------------------------------------------------------------------------------
% File     : ARI747_1 : TPTP v9.3.1. Released v7.0.0.
...
% Refs     :
% Source   : [SMTL]
% Names    : aviation/bts0063_why.p [SMTL]

% Status   : Unsatisfiable
% Rating   : 0.00 v7.0.0
% Syntax   : Number of formulae    :  311 (  19 unt; 141 typ;   0 def)
%            Number of atoms       :  654 ( 441 equ)
%            Maximal formula atoms :   14 (   3 avg)
%            Number of connectives :  505 (  21   ~;   8   |; 348   &)
%                                         (  59 <=>;  69  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   32 (   9 avg)
%            Maximal term depth    :    6 (   1 avg)
%            Number arithmetic     :  390 (  97 atm;  38 fun;  57 num; 198 var)
...
%            Number of variables   :  817 ( 521   !; 296   ?; 817   :)
...
tff(formula_170,axiom,
    ~ ( ( c_Boolean_true = c_Boolean_true )
     => ! [A__questionmark_result: c_unsorted] :
         ...
         => ! [A__questionmark_x: c_unsorted] :
              ( ( c_sort(int32,A__questionmark_x) = c_sort(int32,A__questionmark_result) )
             => ! [A__questionmark_result0: c_unsorted] :
                  ( ( integer_of_int32(c_sort(int32,A__questionmark_result0)) = 2 )
                 => ! [A__questionmark_x0: c_unsorted] :
                    ? [A__questionmark_v_0_288: c_sorted] :
                      ( ( A__questionmark_v_0_288 = c_sort(int32,A__questionmark_x0) )
                      & ( ( A__questionmark_v_0_288 = c_sort(int32,A__questionmark_result0) )
                       => ( integer_of_int32(c_sort(int32,A__questionmark_x)) = $difference(integer_of_int32(A__questionmark_v_0_288),1) ) ) ) ) ) ) ) ).
