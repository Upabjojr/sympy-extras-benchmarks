%------------------------------------------------------------------------------
% File     : ARI275_1 : TPTP v9.3.1. Released v5.0.0.
% Domain   : Arithmetic
% Problem  : Rational: Difference 90/117 and 25/117 is 5/9
% Version  : Especial.
% English  :
...
% Comments :
%------------------------------------------------------------------------------
tff(rat_difference_problem_3,conjecture,
    $difference(90/117,25/117) = 5/9 ).
