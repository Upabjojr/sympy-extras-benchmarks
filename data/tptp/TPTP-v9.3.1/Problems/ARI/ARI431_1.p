%------------------------------------------------------------------------------
% File     : ARI431_1 : TPTP v9.3.1. Released v5.0.0.
% Domain   : Arithmetic
% Problem  : Real: Difference only 16.05 and 12.05 is 4.0
% Version  : Especial.
% English  :
...
% Comments :
%------------------------------------------------------------------------------
tff(real_difference_problem_7,conjecture,
    ! [X: $real] :
      ( ( $difference(X,12.05) = 4.0 )
     => ( X = 16.05 ) ) ).
