%------------------------------------------------------------------------------
% File     : ARI390_1 : TPTP v9.3.1. Released v5.0.0.
% Domain   : Arithmetic
% Problem  : Real: Something greatereq to something else
% Version  : Especial.
% English  :
...
% Comments :
%------------------------------------------------------------------------------
tff(real_greatereq_problem_6,conjecture,
    ? [X: $real,Y: $real] : $greatereq(X,Y) ).
