%------------------------------------------------------------------------------
% File     : ARI552_1 : TPTP v9.3.1. Released v5.0.0.
% Domain   : Arithmetic
% Problem  : Rational: -35/4 less than difference 0/1 and -53/12
% Version  : Especial.
% English  :
...
% Comments :
%------------------------------------------------------------------------------
tff(rat_combined_problem_12,conjecture,
    $less(-35/4,$difference(0/1,-53/12)) ).
