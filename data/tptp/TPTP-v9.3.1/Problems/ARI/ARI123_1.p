%------------------------------------------------------------------------------
% File     : ARI123_1 : TPTP v9.3.1. Released v5.0.0.
% Domain   : Arithmetic
% Problem  : Integer: Associative product exists
% Version  : Especial.
% English  :
...
% Status   : Theorem
% Rating   : 0.00 v7.4.0, 0.12 v7.3.0, 0.17 v7.0.0, 0.14 v6.4.0, 0.00 v6.3.0, 0.14 v6.2.0, 0.25 v6.1.0, 0.11 v6.0.0, 0.14 v5.5.0, 0.11 v5.4.0, 0.12 v5.3.0, 0.20 v5.2.0, 0.17 v5.1.0, 0.20 v5.0.0
...
% Comments :
%------------------------------------------------------------------------------
tff(associative_product_exists,conjecture,
