%------------------------------------------------------------------------------
% File     : ARI541_1 : TPTP v9.3.1. Released v5.0.0.
% Domain   : Arithmetic
% Problem  : Integer: Minus product -18 and -4 greatereq -75
% Version  : Especial.
% English  :
...
% Comments :
%------------------------------------------------------------------------------
tff(int_combined_problem_5,conjecture,
    $greatereq($uminus($product(-18,-4)),-75) ).
