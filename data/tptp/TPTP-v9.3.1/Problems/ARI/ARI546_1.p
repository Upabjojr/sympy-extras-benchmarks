%------------------------------------------------------------------------------
% File     : ARI546_1 : TPTP v9.3.1. Released v5.0.0.
% Domain   : Arithmetic
% Problem  : Integer: Difference -4 and sum 0 and -3 is something
% Version  : Especial.
% English  :
...
%            Number arithmetic     :    6 (   0 atm;   2 fun;   3 num;   1 var)
...
% Comments :
%------------------------------------------------------------------------------
tff(int_combined_problem_10,conjecture,
    ? [X: $int] : ( $difference(-4,$sum(0,-3)) = X ) ).
