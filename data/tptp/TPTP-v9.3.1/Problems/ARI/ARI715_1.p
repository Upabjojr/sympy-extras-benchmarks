%------------------------------------------------------------------------------
% File     : ARI715_1 : TPTP v9.3.1. Released v6.3.0.
% Domain   : Arithmetic
% Problem  : floor(X+0.3) != floor(X)+0.3
% Version  : Especial.
% English  :
...
% Status   : Theorem
% Rating   : 0.40 v9.3.0, 0.38 v9.1.0, 0.50 v9.0.0, 0.38 v7.5.0, 0.40 v7.4.0, 0.50 v7.3.0, 0.67 v7.0.0, 0.43 v6.4.0, 0.33 v6.3.0
...
tff(prove,conjecture,
    ! [X: $real] : ( $floor($sum(X,0.3)) != $sum($floor(X),0.3) ) ).
