%------------------------------------------------------------------------------
% File     : ARI568_1 : TPTP v9.3.1. Released v5.0.0.
% Domain   : Arithmetic
% Problem  : Real: Product of sum -2.8 and -3.6, and 0.0 is 0.0
% Version  : Especial.
% English  :
...
% Comments :
%------------------------------------------------------------------------------
tff(real_combined_problem_19,conjecture,
    $product($sum(-2.8,-3.6),0.0) = 0.0 ).
