%------------------------------------------------------------------------------
% File     : ARI564_1 : TPTP v9.3.1. Released v5.0.0.
% Domain   : Arithmetic
% Problem  : Real: -(-6.48 * -2.25) greatereq to -15.62
% Version  : Especial.
% English  :
...
% Comments :
%------------------------------------------------------------------------------
tff(real_combined_problem_15,conjecture,
    $greatereq($uminus($product(-6.48,-2.25)),-15.62) ).
