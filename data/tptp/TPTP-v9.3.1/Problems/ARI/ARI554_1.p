%------------------------------------------------------------------------------
% File     : ARI554_1 : TPTP v9.3.1. Released v5.0.0.
% Domain   : Arithmetic
% Problem  : Rational: Product 3/8 and 7/10 lesseq to 23/80
% Version  : Especial.
% English  :
...
% Comments :
%------------------------------------------------------------------------------
tff(rat_combined_problem_14,conjecture,
    $lesseq($product(3/8,7/10),23/80) ).
