%------------------------------------------------------------------------------
% File     : ARI756_1 : TPTP v9.3.1. Released v7.0.0.
...
% Refs     :
% Source   : [SMTL]
% Names    : aviation/fs252_why.p [SMTL]

% Status   : Unsatisfiable
% Rating   : 0.00 v9.3.0, 0.50 v9.1.0, 0.40 v8.2.0, 0.50 v8.1.0, 0.67 v7.3.0, 0.75 v7.1.0, 0.67 v7.0.0
% Syntax   : Number of formulae    :  339 (  21 unt; 155 typ;   0 def)
%            Number of atoms       :  700 ( 469 equ)
%            Maximal formula atoms :   14 (   3 avg)
%            Number of connectives :  536 (  20   ~;   8   |; 377   &)
%                                         (  67 <=>;  64  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   32 (   9 avg)
%            Maximal term depth    :    6 (   1 avg)
%            Number arithmetic     :  409 ( 105 atm;  37 fun;  57 num; 210 var)
%            Number of types       :    8 (   5 usr;   2 ari;   0 dat;   0 cdt)
%            Number of type conns  :  274 ( 131   >; 143   *;   0   +;   0  <<)
%            Number of predicates  :   45 (  40 usr;   0 prp; 1-4 aty)
%            Number of functors    :  123 ( 110 usr;  28 con; 0-5 aty)
%            Number of variables   :  869 ( 550   !; 319   ?; 869   :)
...
tff(formula_179,axiom,
    ! [A__questionmark_intuPutu2uallocutableu0_554: c_unsorted] :
    ? [A__questionmark_v_0_305: c_sorted,A__questionmark_v_1_306: c_sorted] :
      ( ( A__questionmark_v_0_305 = c_sort(alloc_table(int_P),A__questionmark_intuPutu2uallocutableu0_554) )
      & ( A__questionmark_v_1_306 = c_sort(pointer(int_P),t) )
      & ( valid_t(A__questionmark_v_0_305)
      <=> ( $lesseq(offset_min(A__questionmark_v_0_305,A__questionmark_v_1_306),0)
          & $greatereq(offset_max(A__questionmark_v_0_305,A__questionmark_v_1_306),4) ) ) ) ).

tff(formula_180,axiom,
    int_of_tag(c_sort(tag_id(void_P),void_P_tag)) = 1 ).

tff(formula_181,axiom,
    ! [A__questionmark_xu561_555: c_unsorted] :
    ? [A__questionmark_v_0_307: c_type] :
      ( ( A__questionmark_v_0_307 = pointer(void_P) )
      & ? [A__questionmark_v_1_308: c_sorted] :
          ( ( A__questionmark_v_1_308 = c_sort(A__questionmark_v_0_307,A__questionmark_xu561_555) )
          & ( c_sort(A__questionmark_v_0_307,void_P_of_bitvector(c_sort(bitvector,bitvector_of_void_P(A__questionmark_v_1_308)))) = A__questionmark_v_1_308 ) ) ) ).

tff(formula_182,axiom,
    ! [A__questionmark_pu562_556: c_unsorted] :
    ? [A__questionmark_v_0_309: c_type] :
      ( ( A__questionmark_v_0_309 = pointer(void_P) )
      & ? [A__questionmark_v_1_310: c_sorted] :
          ( ( A__questionmark_v_1_310 = c_sort(A__questionmark_v_0_309,A__questionmark_pu562_556) )
          & ( A__questionmark_v_1_310 = c_sort(A__questionmark_v_0_309,void_P_of_pointer_address(c_sort(pointer(c_unit),pointer_address(A__questionmark_v_1_310)))) ) ) ) ).

tff(formula_183,axiom,
    ? [A__questionmark_v_0_311: c_type] :
      ( ( A__questionmark_v_0_311 = tag_id(void_P) )
      & parenttag(c_sort(A__questionmark_v_0_311,void_P_tag),c_sort(A__questionmark_v_0_311,bottom_tag)) ) ).

tff(formula_184,axiom,
    ! [A__questionmark_xu564_557: c_unsorted,A__questionmark_voiduPutagutableu563_558: c_unsorted] : instanceof(c_sort(tag_table(void_P),A__questionmark_voiduPutagutableu563_558),c_sort(pointer(void_P),A__questionmark_xu564_557),c_sort(tag_id(void_P),void_P_tag)) ).
