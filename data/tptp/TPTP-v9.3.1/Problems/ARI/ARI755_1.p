%------------------------------------------------------------------------------
% File     : ARI755_1 : TPTP v9.3.1. Released v7.0.0.
...
% Refs     :
% Source   : [SMTL]
% Names    : aviation/false2_why.p [SMTL]

% Status   : Unsatisfiable
% Rating   : 0.00 v9.3.0, 0.50 v9.1.0, 0.40 v8.2.0, 0.50 v8.1.0, 0.67 v7.3.0, 0.50 v7.1.0, 0.67 v7.0.0
% Syntax   : Number of formulae    :  311 (  19 unt; 141 typ;   0 def)
%            Number of atoms       :  656 ( 443 equ)
%            Maximal formula atoms :   14 (   3 avg)
%            Number of connectives :  507 (  21   ~;   8   |; 347   &)
%                                         (  59 <=>;  72  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   32 (   9 avg)
%            Maximal term depth    :    6 (   1 avg)
%            Number arithmetic     :  390 (  97 atm;  37 fun;  58 num; 198 var)
%            Number of types       :    8 (   5 usr;   2 ari;   0 dat;   0 cdt)
%            Number of type conns  :  244 ( 120   >; 124   *;   0   +;   0  <<)
%            Number of predicates  :   37 (  32 usr;   0 prp; 1-4 aty)
%            Number of functors    :  116 ( 104 usr;  24 con; 0-5 aty)
%            Number of variables   :  818 ( 523   !; 295   ?; 818   :)
...
tff(formula_135,axiom,
    ...
    ? [A__questionmark_v_0_237: c_sorted] :
      ...
      & ( c_sort(bitvector,bitvector_of_void_P(c_sort(pointer(void_P),void_P_of_bitvector(A__questionmark_v_0_237)))) = A__questionmark_v_0_237 ) ) ).
...
tff(formula_137,axiom,
    ...
    ? [A__questionmark_v_0_238: c_type] :
      ( ( A__questionmark_v_0_238 = pointer(char_P) )
      & ? [A__questionmark_v_1_239: c_sorted] :
          ( ( A__questionmark_v_1_239 = c_sort(A__questionmark_v_0_238,A__questionmark_xu543_454) )
          & ( c_sort(A__questionmark_v_0_238,char_P_of_bitvector(c_sort(bitvector,bitvector_of_char_P(A__questionmark_v_1_239)))) = A__questionmark_v_1_239 ) ) ) ).

tff(formula_138,axiom,
    ! [A__questionmark_pu544_455: c_unsorted] :
    ? [A__questionmark_v_0_240: c_type] :
      ( ( A__questionmark_v_0_240 = pointer(char_P) )
      & ? [A__questionmark_v_1_241: c_sorted] :
          ( ( A__questionmark_v_1_241 = c_sort(A__questionmark_v_0_240,A__questionmark_pu544_455) )
          & ( A__questionmark_v_1_241 = c_sort(A__questionmark_v_0_240,char_P_of_pointer_address(c_sort(pointer(c_unit),pointer_address(A__questionmark_v_1_241)))) ) ) ) ).

tff(formula_139,axiom,
    ? [A__questionmark_v_0_242: c_type] :
      ( ( A__questionmark_v_0_242 = tag_id(char_P) )
      & parenttag(c_sort(A__questionmark_v_0_242,char_P_tag),c_sort(A__questionmark_v_0_242,bottom_tag)) ) ).

tff(formula_140,axiom,
    ! [A__questionmark_xu546_456: c_unsorted,A__questionmark_charuPutagutableu545_457: c_unsorted] : instanceof(c_sort(tag_table(char_P),A__questionmark_charuPutagutableu545_457),c_sort(pointer(char_P),A__questionmark_xu546_456),c_sort(tag_id(char_P),char_P_tag)) ).

tff(formula_141,axiom,
    ! [A__questionmark_xu0_458: c_unsorted,A__questionmark_yu0_459: c_unsorted] :
    ? [A__questionmark_v_0_243: c_sorted,A__questionmark_v_1_244: c_sorted] :
      ( ( A__questionmark_v_0_243 = c_sort(int32,A__questionmark_xu0_458) )
      & ( A__questionmark_v_1_244 = c_sort(int32,A__questionmark_yu0_459) )
      & ( eq_int32(A__questionmark_v_0_243,A__questionmark_v_1_244)
      <=> ( integer_of_int32(A__questionmark_v_0_243) = integer_of_int32(A__questionmark_v_1_244) ) ) ) ).

tff(formula_142,axiom,
    ! [A__questionmark_xu0_460: c_unsorted,A__questionmark_yu0_461: c_unsorted] :
    ? [A__questionmark_v_0_245: c_sorted,A__questionmark_v_1_246: c_sorted] :
      ( ( A__questionmark_v_0_245 = c_sort(int8,A__questionmark_xu0_460) )
      & ( A__questionmark_v_1_246 = c_sort(int8,A__questionmark_yu0_461) )
      & ( eq_int8(A__questionmark_v_0_245,A__questionmark_v_1_246)
      <=> ( integer_of_int8(A__questionmark_v_0_245) = integer_of_int8(A__questionmark_v_1_246) ) ) ) ).

tff(formula_143,axiom,
    ! [A__questionmark_xu547_462: $int] :
      ( ( $lesseq($uminus(2147483648),A__questionmark_xu547_462)
        & $lesseq(A__questionmark_xu547_462,2147483647) )
     => ( integer_of_int32(c_sort(int32,int32_of_integer(A__questionmark_xu547_462))) = A__questionmark_xu547_462 ) ) ).

tff(formula_144,axiom,
    ! [A__questionmark_xu548_463: c_unsorted] :
    ? [A__questionmark_v_0_247: c_sorted] :
      ( ( A__questionmark_v_0_247 = c_sort(int32,A__questionmark_xu548_463) )
      & eq_int32(c_sort(int32,int32_of_bitvector(c_sort(bitvector,bitvector_of_int32(A__questionmark_v_0_247)))),A__questionmark_v_0_247) ) ).

tff(formula_145,axiom,
    ! [A__questionmark_xu549_464: c_unsorted] :
    ? [A__questionmark_v_0_248: $int] :
      ( ( A__questionmark_v_0_248 = integer_of_int32(c_sort(int32,A__questionmark_xu549_464)) )
      & $lesseq($uminus(2147483648),A__questionmark_v_0_248)
      & $lesseq(A__questionmark_v_0_248,2147483647) ) ).

tff(formula_146,axiom,
    ! [A__questionmark_xu550_465: $int] :
      ( ( $lesseq($uminus(128),A__questionmark_xu550_465)
        & $lesseq(A__questionmark_xu550_465,127) )
     => ( integer_of_int8(c_sort(int8,int8_of_integer(A__questionmark_xu550_465))) = A__questionmark_xu550_465 ) ) ).

tff(formula_147,axiom,
    ! [A__questionmark_xu551_466: c_unsorted] :
    ? [A__questionmark_v_0_249: c_sorted] :
      ( ( A__questionmark_v_0_249 = c_sort(int8,A__questionmark_xu551_466) )
      & eq_int8(c_sort(int8,int8_of_bitvector(c_sort(bitvector,bitvector_of_int8(A__questionmark_v_0_249)))),A__questionmark_v_0_249) ) ).

tff(formula_148,axiom,
    ! [A__questionmark_xu552_467: c_unsorted] :
    ? [A__questionmark_v_0_250: $int] :
      ( ( A__questionmark_v_0_250 = integer_of_int8(c_sort(int8,A__questionmark_xu552_467)) )
      & $lesseq($uminus(128),A__questionmark_v_0_250)
      & $lesseq(A__questionmark_v_0_250,127) ) ).

tff(formula_149,axiom,
    ! [A__questionmark_pu0_468: c_unsorted,A__questionmark_au0_469: $int,A__questionmark_charuPuallocutableu0_470: c_unsorted] :
    ? [A__questionmark_v_1_251: c_sorted,A__questionmark_v_0_252: c_sorted] :
      ( ( A__questionmark_v_1_251 = c_sort(pointer(char_P),A__questionmark_pu0_468) )
      & ( A__questionmark_v_0_252 = c_sort(alloc_table(char_P),A__questionmark_charuPuallocutableu0_470) )
      & ( left_valid_struct_char_P(A__questionmark_v_1_251,A__questionmark_au0_469,A__questionmark_v_0_252)
      <=> $lesseq(offset_min(A__questionmark_v_0_252,A__questionmark_v_1_251),A__questionmark_au0_469) ) ) ).

tff(formula_150,axiom,
    ! [A__questionmark_pu0_471: c_unsorted,A__questionmark_au0_472: $int,A__questionmark_voiduPuallocutableu0_473: c_unsorted] :
    ? [A__questionmark_v_1_253: c_sorted,A__questionmark_v_0_254: c_sorted] :
      ( ( A__questionmark_v_1_253 = c_sort(pointer(void_P),A__questionmark_pu0_471) )
      & ( A__questionmark_v_0_254 = c_sort(alloc_table(void_P),A__questionmark_voiduPuallocutableu0_473) )
      & ( left_valid_struct_void_P(A__questionmark_v_1_253,A__questionmark_au0_472,A__questionmark_v_0_254)
      <=> $lesseq(offset_min(A__questionmark_v_0_254,A__questionmark_v_1_253),A__questionmark_au0_472) ) ) ).

tff(formula_151,axiom,
    ! [A__questionmark_pu553_474: c_unsorted] :
    ? [A__questionmark_v_0_255: c_type] :
      ( ( A__questionmark_v_0_255 = pointer(c_unit) )
      & ? [A__questionmark_v_1_256: c_sorted] :
          ( ( A__questionmark_v_1_256 = c_sort(A__questionmark_v_0_255,A__questionmark_pu553_474) )
          & ( A__questionmark_v_1_256 = c_sort(A__questionmark_v_0_255,pointer_address(c_sort(pointer(char_P),char_P_of_pointer_address(A__questionmark_v_1_256)))) ) ) ) ).

tff(formula_152,axiom,
    ! [A__questionmark_pu554_475: c_unsorted] :
    ? [A__questionmark_v_0_257: c_type] :
      ( ( A__questionmark_v_0_257 = pointer(c_unit) )
      & ? [A__questionmark_v_1_258: c_sorted] :
          ( ( A__questionmark_v_1_258 = c_sort(A__questionmark_v_0_257,A__questionmark_pu554_475) )
          & ( A__questionmark_v_1_258 = c_sort(A__questionmark_v_0_257,pointer_address(c_sort(pointer(void_P),void_P_of_pointer_address(A__questionmark_v_1_258)))) ) ) ) ).

tff(formula_153,axiom,
    ! [A__questionmark_pu0_476: c_unsorted,A__questionmark_bu0_477: $int,A__questionmark_charuPuallocutableu0_478: c_unsorted] :
    ? [A__questionmark_v_1_259: c_sorted,A__questionmark_v_0_260: c_sorted] :
      ( ( A__questionmark_v_1_259 = c_sort(pointer(char_P),A__questionmark_pu0_476) )
      & ( A__questionmark_v_0_260 = c_sort(alloc_table(char_P),A__questionmark_charuPuallocutableu0_478) )
      & ( right_valid_struct_char_P(A__questionmark_v_1_259,A__questionmark_bu0_477,A__questionmark_v_0_260)
      <=> $greatereq(offset_max(A__questionmark_v_0_260,A__questionmark_v_1_259),A__questionmark_bu0_477) ) ) ).

tff(formula_154,axiom,
    ! [A__questionmark_pu0_479: c_unsorted,A__questionmark_bu0_480: $int,A__questionmark_voiduPuallocutableu0_481: c_unsorted] :
    ? [A__questionmark_v_1_261: c_sorted,A__questionmark_v_0_262: c_sorted] :
      ...
      & ( right_valid_struct_void_P(A__questionmark_v_1_261,A__questionmark_bu0_480,A__questionmark_v_0_262)
      <=> $greatereq(offset_max(A__questionmark_v_0_262,A__questionmark_v_1_261),A__questionmark_bu0_480) ) ) ).

tff(formula_155,axiom,
    ! [A__questionmark_pu0_482: c_unsorted,A__questionmark_au0_483: $int,A__questionmark_bu0_484: $int,A__questionmark_charuPuallocutableu0_485: c_unsorted] :
    ? [A__questionmark_v_1_263: c_sorted,A__questionmark_v_0_264: c_sorted] :
      ( ( A__questionmark_v_1_263 = c_sort(pointer(char_P),A__questionmark_pu0_482) )
      & ( A__questionmark_v_0_264 = c_sort(alloc_table(char_P),A__questionmark_charuPuallocutableu0_485) )
      & ( strict_valid_root_char_P(A__questionmark_v_1_263,A__questionmark_au0_483,A__questionmark_bu0_484,A__questionmark_v_0_264)
      <=> ( ( offset_min(A__questionmark_v_0_264,A__questionmark_v_1_263) = A__questionmark_au0_483 )
          & ( offset_max(A__questionmark_v_0_264,A__questionmark_v_1_263) = A__questionmark_bu0_484 ) ) ) ) ).

tff(formula_156,axiom,
    ! [A__questionmark_pu0_486: c_unsorted,A__questionmark_au0_487: $int,A__questionmark_bu0_488: $int,A__questionmark_voiduPuallocutableu0_489: c_unsorted] :
    ? [A__questionmark_v_1_265: c_sorted,A__questionmark_v_0_266: c_sorted] :
      ( ( A__questionmark_v_1_265 = c_sort(pointer(void_P),A__questionmark_pu0_486) )
      & ( A__questionmark_v_0_266 = c_sort(alloc_table(void_P),A__questionmark_voiduPuallocutableu0_489) )
      & ( strict_valid_root_void_P(A__questionmark_v_1_265,A__questionmark_au0_487,A__questionmark_bu0_488,A__questionmark_v_0_266)
      <=> ( ( offset_min(A__questionmark_v_0_266,A__questionmark_v_1_265) = A__questionmark_au0_487 )
          & ( offset_max(A__questionmark_v_0_266,A__questionmark_v_1_265) = A__questionmark_bu0_488 ) ) ) ) ).

tff(formula_157,axiom,
    ! [A__questionmark_pu0_490: c_unsorted,A__questionmark_au0_491: $int,A__questionmark_bu0_492: $int,A__questionmark_charuPuallocutableu0_493: c_unsorted] :
    ? [A__questionmark_v_1_267: c_sorted,A__questionmark_v_0_268: c_sorted] :
      ( ( A__questionmark_v_1_267 = c_sort(pointer(char_P),A__questionmark_pu0_490) )
      & ( A__questionmark_v_0_268 = c_sort(alloc_table(char_P),A__questionmark_charuPuallocutableu0_493) )
      & ( strict_valid_struct_char_P(A__questionmark_v_1_267,A__questionmark_au0_491,A__questionmark_bu0_492,A__questionmark_v_0_268)
      <=> ( ( offset_min(A__questionmark_v_0_268,A__questionmark_v_1_267) = A__questionmark_au0_491 )
          & ( offset_max(A__questionmark_v_0_268,A__questionmark_v_1_267) = A__questionmark_bu0_492 ) ) ) ) ).

tff(formula_158,axiom,
    ! [A__questionmark_pu0_494: c_unsorted,A__questionmark_au0_495: $int,A__questionmark_bu0_496: $int,A__questionmark_voiduPuallocutableu0_497: c_unsorted] :
    ? [A__questionmark_v_1_269: c_sorted,A__questionmark_v_0_270: c_sorted] :
      ( ( A__questionmark_v_1_269 = c_sort(pointer(void_P),A__questionmark_pu0_494) )
      & ( A__questionmark_v_0_270 = c_sort(alloc_table(void_P),A__questionmark_voiduPuallocutableu0_497) )
      & ( strict_valid_struct_void_P(A__questionmark_v_1_269,A__questionmark_au0_495,A__questionmark_bu0_496,A__questionmark_v_0_270)
      <=> ( ( offset_min(A__questionmark_v_0_270,A__questionmark_v_1_269) = A__questionmark_au0_495 )
          & ( offset_max(A__questionmark_v_0_270,A__questionmark_v_1_269) = A__questionmark_bu0_496 ) ) ) ) ).

tff(formula_159,axiom,
    ! [A__questionmark_pu0_498: c_unsorted,A__questionmark_au0_499: $int,A__questionmark_bu0_500: $int,A__questionmark_bitvectoruallocutableu0_501: c_unsorted] :
    ? [A__questionmark_v_1_271: c_sorted,A__questionmark_v_0_272: c_sorted] :
      ( ( A__questionmark_v_1_271 = c_sort(pointer(c_unit),A__questionmark_pu0_498) )
      & ( A__questionmark_v_0_272 = c_sort(alloc_table(c_unit),A__questionmark_bitvectoruallocutableu0_501) )
      & ( valid_bitvector_struct_char_P(A__questionmark_v_1_271,A__questionmark_au0_499,A__questionmark_bu0_500,A__questionmark_v_0_272)
      <=> ( ( offset_min(A__questionmark_v_0_272,A__questionmark_v_1_271) = A__questionmark_au0_499 )
          & ( offset_max(A__questionmark_v_0_272,A__questionmark_v_1_271) = A__questionmark_bu0_500 ) ) ) ) ).

tff(formula_160,axiom,
    ! [A__questionmark_pu0_502: c_unsorted,A__questionmark_au0_503: $int,A__questionmark_bu0_504: $int,A__questionmark_bitvectoruallocutableu0_505: c_unsorted] :
    ? [A__questionmark_v_1_273: c_sorted,A__questionmark_v_0_274: c_sorted] :
      ( ( A__questionmark_v_1_273 = c_sort(pointer(c_unit),A__questionmark_pu0_502) )
      & ( A__questionmark_v_0_274 = c_sort(alloc_table(c_unit),A__questionmark_bitvectoruallocutableu0_505) )
      & ( valid_bitvector_struct_void_P(A__questionmark_v_1_273,A__questionmark_au0_503,A__questionmark_bu0_504,A__questionmark_v_0_274)
      <=> ( ( offset_min(A__questionmark_v_0_274,A__questionmark_v_1_273) = A__questionmark_au0_503 )
          & ( offset_max(A__questionmark_v_0_274,A__questionmark_v_1_273) = A__questionmark_bu0_504 ) ) ) ) ).
...
tff(formula_161,axiom,
    ...
    ? [A__questionmark_v_1_275: c_sorted,A__questionmark_v_0_276: c_sorted] :
      ( ( A__questionmark_v_1_275 = c_sort(pointer(char_P),A__questionmark_pu0_506) )
      & ( A__questionmark_v_0_276 = c_sort(alloc_table(char_P),A__questionmark_charuPuallocutableu0_509) )
      & ( valid_root_char_P(A__questionmark_v_1_275,A__questionmark_au0_507,A__questionmark_bu0_508,A__questionmark_v_0_276)
      <=> ( $lesseq(offset_min(A__questionmark_v_0_276,A__questionmark_v_1_275),A__questionmark_au0_507)
          & $greatereq(offset_max(A__questionmark_v_0_276,A__questionmark_v_1_275),A__questionmark_bu0_508) ) ) ) ).

tff(formula_162,axiom,
    ! [A__questionmark_pu0_510: c_unsorted,A__questionmark_au0_511: $int,A__questionmark_bu0_512: $int,A__questionmark_voiduPuallocutableu0_513: c_unsorted] :
    ? [A__questionmark_v_1_277: c_sorted,A__questionmark_v_0_278: c_sorted] :
      ( ( A__questionmark_v_1_277 = c_sort(pointer(void_P),A__questionmark_pu0_510) )
      & ( A__questionmark_v_0_278 = c_sort(alloc_table(void_P),A__questionmark_voiduPuallocutableu0_513) )
      & ( valid_root_void_P(A__questionmark_v_1_277,A__questionmark_au0_511,A__questionmark_bu0_512,A__questionmark_v_0_278)
      <=> ( $lesseq(offset_min(A__questionmark_v_0_278,A__questionmark_v_1_277),A__questionmark_au0_511)
          & $greatereq(offset_max(A__questionmark_v_0_278,A__questionmark_v_1_277),A__questionmark_bu0_512) ) ) ) ).

tff(formula_163,axiom,
    ! [A__questionmark_pu0_514: c_unsorted,A__questionmark_au0_515: $int,A__questionmark_bu0_516: $int,A__questionmark_charuPuallocutableu0_517: c_unsorted] :
    ? [A__questionmark_v_1_279: c_sorted,A__questionmark_v_0_280: c_sorted] :
      ( ( A__questionmark_v_1_279 = c_sort(pointer(char_P),A__questionmark_pu0_514) )
      & ( A__questionmark_v_0_280 = c_sort(alloc_table(char_P),A__questionmark_charuPuallocutableu0_517) )
      & ( valid_struct_char_P(A__questionmark_v_1_279,A__questionmark_au0_515,A__questionmark_bu0_516,A__questionmark_v_0_280)
      <=> ( $lesseq(offset_min(A__questionmark_v_0_280,A__questionmark_v_1_279),A__questionmark_au0_515)
          & $greatereq(offset_max(A__questionmark_v_0_280,A__questionmark_v_1_279),A__questionmark_bu0_516) ) ) ) ).

tff(formula_164,axiom,
    ! [A__questionmark_pu0_518: c_unsorted,A__questionmark_au0_519: $int,A__questionmark_bu0_520: $int,A__questionmark_voiduPuallocutableu0_521: c_unsorted] :
    ? [A__questionmark_v_1_281: c_sorted,A__questionmark_v_0_282: c_sorted] :
      ( ( A__questionmark_v_1_281 = c_sort(pointer(void_P),A__questionmark_pu0_518) )
      & ( A__questionmark_v_0_282 = c_sort(alloc_table(void_P),A__questionmark_voiduPuallocutableu0_521) )
      & ( valid_struct_void_P(A__questionmark_v_1_281,A__questionmark_au0_519,A__questionmark_bu0_520,A__questionmark_v_0_282)
      <=> ( $lesseq(offset_min(A__questionmark_v_0_282,A__questionmark_v_1_281),A__questionmark_au0_519)
          & $greatereq(offset_max(A__questionmark_v_0_282,A__questionmark_v_1_281),A__questionmark_bu0_520) ) ) ) ).

tff(formula_165,axiom,
    int_of_tag(c_sort(tag_id(void_P),void_P_tag)) = 1 ).

tff(formula_166,axiom,
    ! [A__questionmark_xu555_522: c_unsorted] :
    ? [A__questionmark_v_0_283: c_type] :
      ( ( A__questionmark_v_0_283 = pointer(void_P) )
      & ? [A__questionmark_v_1_284: c_sorted] :
          ( ( A__questionmark_v_1_284 = c_sort(A__questionmark_v_0_283,A__questionmark_xu555_522) )
          & ( c_sort(A__questionmark_v_0_283,void_P_of_bitvector(c_sort(bitvector,bitvector_of_void_P(A__questionmark_v_1_284)))) = A__questionmark_v_1_284 ) ) ) ).

tff(formula_167,axiom,
    ! [A__questionmark_pu556_523: c_unsorted] :
    ? [A__questionmark_v_0_285: c_type] :
      ( ( A__questionmark_v_0_285 = pointer(void_P) )
      & ? [A__questionmark_v_1_286: c_sorted] :
          ( ( A__questionmark_v_1_286 = c_sort(A__questionmark_v_0_285,A__questionmark_pu556_523) )
          & ( A__questionmark_v_1_286 = c_sort(A__questionmark_v_0_285,void_P_of_pointer_address(c_sort(pointer(c_unit),pointer_address(A__questionmark_v_1_286)))) ) ) ) ).

tff(formula_168,axiom,
    ? [A__questionmark_v_0_287: c_type] :
      ( ( A__questionmark_v_0_287 = tag_id(void_P) )
      & parenttag(c_sort(A__questionmark_v_0_287,void_P_tag),c_sort(A__questionmark_v_0_287,bottom_tag)) ) ).

tff(formula_169,axiom,
    ! [A__questionmark_xu558_524: c_unsorted,A__questionmark_voiduPutagutableu557_525: c_unsorted] : instanceof(c_sort(tag_table(void_P),A__questionmark_voiduPutagutableu557_525),c_sort(pointer(void_P),A__questionmark_xu558_524),c_sort(tag_id(void_P),void_P_tag)) ).

tff(formula_170,axiom,
    ~ ( ( c_Boolean_true = c_Boolean_true )
     => ! [A__questionmark_result: c_unsorted] :
          ( ( integer_of_int32(c_sort(int32,A__questionmark_result)) = 1 )
         => ! [A__questionmark_e: c_unsorted] :
              ( ( c_sort(int32,A__questionmark_e) = c_sort(int32,A__questionmark_result) )
             => ! [A__questionmark_e0: c_unsorted] :
                  ( ( ( c_Boolean_true = c_Boolean_true )
                   => ( integer_of_int32(c_sort(int32,A__questionmark_e0)) = 0 ) )
                 => ! [A__questionmark_result0: c_unsorted] :
                      ( ( integer_of_int32(c_sort(int32,A__questionmark_result0)) = 0 )
                     => ! [A__questionmark_smtlib____retres: c_unsorted] :
                          ( ( c_sort(int32,A__questionmark_smtlib____retres) = c_sort(int32,A__questionmark_result0) )
                         => ! [A__questionmark_return: c_unsorted] :
                              ( ( c_sort(int32,A__questionmark_return) = c_sort(int32,A__questionmark_smtlib____retres) )
                             => ( integer_of_int32(c_sort(int32,A__questionmark_e0)) = 1 ) ) ) ) ) ) ) ) ).
