%------------------------------------------------------------------------------
% File     : ARI274_1 : TPTP v9.3.1. Released v5.0.0.
% Domain   : Arithmetic
% Problem  : Rational: Difference 5/12 and 1/2 is -1/12
% Version  : Especial.
% English  :
...
% Comments :
%------------------------------------------------------------------------------
tff(rat_difference_problem_2,conjecture,
    $difference(5/12,1/2) = -1/12 ).
