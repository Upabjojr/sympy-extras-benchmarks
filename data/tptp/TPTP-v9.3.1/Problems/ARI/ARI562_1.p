%------------------------------------------------------------------------------
% File     : ARI562_1 : TPTP v9.3.1. Released v5.0.0.
% Domain   : Arithmetic
% Problem  : Real: Sum 0.52 and 0.6 greater than -0.055
% Version  : Especial.
% English  :
...
% Comments :
%------------------------------------------------------------------------------
tff(real_combined_problem_13,conjecture,
    $greater($sum(0.52,0.6),-0.055) ).
