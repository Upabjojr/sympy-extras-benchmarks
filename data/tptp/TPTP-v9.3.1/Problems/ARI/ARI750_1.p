%------------------------------------------------------------------------------
% File     : ARI750_1 : TPTP v9.3.1. Released v7.0.0.
...
% Refs     :
% Source   : [SMTL]
% Names    : aviation/clash_alloc_why.p [SMTL]

% Status   : Unsatisfiable
% Rating   : 0.00 v9.3.0, 0.25 v9.1.0, 0.20 v8.2.0, 0.25 v8.1.0, 0.33 v7.3.0, 0.25 v7.1.0, 0.33 v7.0.0
% Syntax   : Number of formulae    :  337 (  21 unt; 153 typ;   0 def)
%            Number of atoms       :  701 ( 470 equ)
%            Maximal formula atoms :   14 (   3 avg)
%            Number of connectives :  538 (  21   ~;   8   |; 378   &)
%                                         (  66 <=>;  65  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   32 (   9 avg)
%            Maximal term depth    :    6 (   1 avg)
%            Number arithmetic     :  412 ( 106 atm;  37 fun;  58 num; 211 var)
...
tff(valid_bitvector_struct_T,type,
...
tff(right_valid_struct_T,type,
    right_valid_struct_T: ( c_sorted * $int * c_sorted ) > $o ).

tff('T_of_pointer_address',type,
...
tff(strict_valid_struct_T,type,
...
tff(formula_132,axiom,
    int_of_tag(c_sort(tag_id('T'),'T_tag')) = 1 ).

tff(formula_133,axiom,
    ! [A__questionmark_xu539_450: c_unsorted] :
    ? [A__questionmark_v_0_234: c_type] :
      ( ( A__questionmark_v_0_234 = pointer('T') )
      & ? [A__questionmark_v_1_235: c_sorted] :
          ( ( A__questionmark_v_1_235 = c_sort(A__questionmark_v_0_234,A__questionmark_xu539_450) )
          & ( c_sort(A__questionmark_v_0_234,'T_of_bitvector'(c_sort(bitvector,bitvector_of_T(A__questionmark_v_1_235)))) = A__questionmark_v_1_235 ) ) ) ).

tff(formula_134,axiom,
    ! [A__questionmark_pu540_451: c_unsorted] :
    ? [A__questionmark_v_0_236: c_type] :
      ( ( A__questionmark_v_0_236 = pointer('T') )
      & ? [A__questionmark_v_1_237: c_sorted] :
          ( ( A__questionmark_v_1_237 = c_sort(A__questionmark_v_0_236,A__questionmark_pu540_451) )
          & ( A__questionmark_v_1_237 = c_sort(A__questionmark_v_0_236,'T_of_pointer_address'(c_sort(pointer(c_unit),pointer_address(A__questionmark_v_1_237)))) ) ) ) ).

tff(formula_135,axiom,
    ? [A__questionmark_v_0_238: c_type] :
      ( ( A__questionmark_v_0_238 = tag_id('T') )
      & parenttag(c_sort(A__questionmark_v_0_238,'T_tag'),c_sort(A__questionmark_v_0_238,bottom_tag)) ) ).

tff(formula_136,axiom,
    ! [A__questionmark_xu542_452: c_unsorted,A__questionmark_Tutagutableu541_453: c_unsorted] : instanceof(c_sort(tag_table('T'),A__questionmark_Tutagutableu541_453),c_sort(pointer('T'),A__questionmark_xu542_452),c_sort(tag_id('T'),'T_tag')) ).
...
tff(formula_137,axiom,
    ...
    ? [A__questionmark_v_0_239: c_sorted] :
      ...
      & ( c_sort(bitvector,bitvector_of_T(c_sort(pointer('T'),'T_of_bitvector'(A__questionmark_v_0_239)))) = A__questionmark_v_0_239 ) ) ).
...
tff(formula_155,axiom,
    ! [A__questionmark_pu0_473: c_unsorted,A__questionmark_au0_474: $int,A__questionmark_Tuallocutableu0_475: c_unsorted] :
    ? [A__questionmark_v_1_257: c_sorted,A__questionmark_v_0_258: c_sorted] :
      ( ( A__questionmark_v_1_257 = c_sort(pointer('T'),A__questionmark_pu0_473) )
      & ( A__questionmark_v_0_258 = c_sort(alloc_table('T'),A__questionmark_Tuallocutableu0_475) )
      & ( left_valid_struct_T(A__questionmark_v_1_257,A__questionmark_au0_474,A__questionmark_v_0_258)
      <=> $lesseq(offset_min(A__questionmark_v_0_258,A__questionmark_v_1_257),A__questionmark_au0_474) ) ) ).

tff(formula_156,axiom,
    ! [A__questionmark_pu0_476: c_unsorted,A__questionmark_au0_477: $int,A__questionmark_charuPuallocutableu0_478: c_unsorted] :
    ? [A__questionmark_v_1_259: c_sorted,A__questionmark_v_0_260: c_sorted] :
      ...
      & ( left_valid_struct_char_P(A__questionmark_v_1_259,A__questionmark_au0_477,A__questionmark_v_0_260)
...
tff(formula_158,axiom,
    ...
    ? [A__questionmark_v_0_263: c_type] :
      ...
      & ? [A__questionmark_v_1_264: c_sorted] :
          ...
          & ( A__questionmark_v_1_264 = c_sort(A__questionmark_v_0_263,pointer_address(c_sort(pointer('T'),'T_of_pointer_address'(A__questionmark_v_1_264)))) ) ) ) ).
...
tff(formula_159,axiom,
    ...
    ? [A__questionmark_v_0_265: c_type] :
      ...
      & ? [A__questionmark_v_1_266: c_sorted] :
          ...
          & ( A__questionmark_v_1_266 = c_sort(A__questionmark_v_0_265,pointer_address(c_sort(pointer(char_P),char_P_of_pointer_address(A__questionmark_v_1_266)))) ) ) ) ).
...
tff(formula_161,axiom,
    ! [A__questionmark_pu0_485: c_unsorted,A__questionmark_bu0_486: $int,A__questionmark_Tuallocutableu0_487: c_unsorted] :
    ? [A__questionmark_v_1_269: c_sorted,A__questionmark_v_0_270: c_sorted] :
      ( ( A__questionmark_v_1_269 = c_sort(pointer('T'),A__questionmark_pu0_485) )
      & ( A__questionmark_v_0_270 = c_sort(alloc_table('T'),A__questionmark_Tuallocutableu0_487) )
      & ( right_valid_struct_T(A__questionmark_v_1_269,A__questionmark_bu0_486,A__questionmark_v_0_270)
      <=> $greatereq(offset_max(A__questionmark_v_0_270,A__questionmark_v_1_269),A__questionmark_bu0_486) ) ) ).

tff(formula_162,axiom,
    ! [A__questionmark_pu0_488: c_unsorted,A__questionmark_bu0_489: $int,A__questionmark_charuPuallocutableu0_490: c_unsorted] :
    ? [A__questionmark_v_1_271: c_sorted,A__questionmark_v_0_272: c_sorted] :
      ( ( A__questionmark_v_1_271 = c_sort(pointer(char_P),A__questionmark_pu0_488) )
      & ( A__questionmark_v_0_272 = c_sort(alloc_table(char_P),A__questionmark_charuPuallocutableu0_490) )
      & ( right_valid_struct_char_P(A__questionmark_v_1_271,A__questionmark_bu0_489,A__questionmark_v_0_272)
...
tff(formula_164,axiom,
    ! [A__questionmark_pu0_494: c_unsorted,A__questionmark_au0_495: $int,A__questionmark_bu0_496: $int,A__questionmark_Tuallocutableu0_497: c_unsorted] :
    ? [A__questionmark_v_1_275: c_sorted,A__questionmark_v_0_276: c_sorted] :
      ( ( A__questionmark_v_1_275 = c_sort(pointer('T'),A__questionmark_pu0_494) )
      & ( A__questionmark_v_0_276 = c_sort(alloc_table('T'),A__questionmark_Tuallocutableu0_497) )
      & ( strict_valid_root_T(A__questionmark_v_1_275,A__questionmark_au0_495,A__questionmark_bu0_496,A__questionmark_v_0_276)
...
tff(formula_165,axiom,
    ! [A__questionmark_pu0_498: c_unsorted,A__questionmark_au0_499: $int,A__questionmark_bu0_500: $int,A__questionmark_charuPuallocutableu0_501: c_unsorted] :
    ? [A__questionmark_v_1_277: c_sorted,A__questionmark_v_0_278: c_sorted] :
      ( ( A__questionmark_v_1_277 = c_sort(pointer(char_P),A__questionmark_pu0_498) )
      & ( A__questionmark_v_0_278 = c_sort(alloc_table(char_P),A__questionmark_charuPuallocutableu0_501) )
      & ( strict_valid_root_char_P(A__questionmark_v_1_277,A__questionmark_au0_499,A__questionmark_bu0_500,A__questionmark_v_0_278)
...
tff(formula_167,axiom,
    ! [A__questionmark_pu0_506: c_unsorted,A__questionmark_au0_507: $int,A__questionmark_bu0_508: $int,A__questionmark_Tuallocutableu0_509: c_unsorted] :
    ? [A__questionmark_v_1_281: c_sorted,A__questionmark_v_0_282: c_sorted] :
      ( ( A__questionmark_v_1_281 = c_sort(pointer('T'),A__questionmark_pu0_506) )
      & ( A__questionmark_v_0_282 = c_sort(alloc_table('T'),A__questionmark_Tuallocutableu0_509) )
      & ( strict_valid_struct_T(A__questionmark_v_1_281,A__questionmark_au0_507,A__questionmark_bu0_508,A__questionmark_v_0_282)
...
tff(formula_168,axiom,
    ! [A__questionmark_pu0_510: c_unsorted,A__questionmark_au0_511: $int,A__questionmark_bu0_512: $int,A__questionmark_charuPuallocutableu0_513: c_unsorted] :
    ? [A__questionmark_v_1_283: c_sorted,A__questionmark_v_0_284: c_sorted] :
      ( ( A__questionmark_v_1_283 = c_sort(pointer(char_P),A__questionmark_pu0_510) )
      & ( A__questionmark_v_0_284 = c_sort(alloc_table(char_P),A__questionmark_charuPuallocutableu0_513) )
      & ( strict_valid_struct_char_P(A__questionmark_v_1_283,A__questionmark_au0_511,A__questionmark_bu0_512,A__questionmark_v_0_284)
...
tff(formula_170,axiom,
    ...
    ? [A__questionmark_v_1_287: c_sorted,A__questionmark_v_0_288: c_sorted] :
      ...
      & ( valid_bitvector_struct_T(A__questionmark_v_1_287,A__questionmark_au0_519,A__questionmark_bu0_520,A__questionmark_v_0_288)
...
tff(formula_171,axiom,
    ...
    ? [A__questionmark_v_1_289: c_sorted,A__questionmark_v_0_290: c_sorted] :
      ...
      & ( valid_bitvector_struct_char_P(A__questionmark_v_1_289,A__questionmark_au0_523,A__questionmark_bu0_524,A__questionmark_v_0_290)
...
tff(formula_173,axiom,
    ! [A__questionmark_pu0_530: c_unsorted,A__questionmark_au0_531: $int,A__questionmark_bu0_532: $int,A__questionmark_Tuallocutableu0_533: c_unsorted] :
    ? [A__questionmark_v_1_293: c_sorted,A__questionmark_v_0_294: c_sorted] :
      ( ( A__questionmark_v_1_293 = c_sort(pointer('T'),A__questionmark_pu0_530) )
      & ( A__questionmark_v_0_294 = c_sort(alloc_table('T'),A__questionmark_Tuallocutableu0_533) )
      & ( valid_root_T(A__questionmark_v_1_293,A__questionmark_au0_531,A__questionmark_bu0_532,A__questionmark_v_0_294)
...
tff(formula_174,axiom,
    ! [A__questionmark_pu0_534: c_unsorted,A__questionmark_au0_535: $int,A__questionmark_bu0_536: $int,A__questionmark_charuPuallocutableu0_537: c_unsorted] :
    ? [A__questionmark_v_1_295: c_sorted,A__questionmark_v_0_296: c_sorted] :
      ( ( A__questionmark_v_1_295 = c_sort(pointer(char_P),A__questionmark_pu0_534) )
      & ( A__questionmark_v_0_296 = c_sort(alloc_table(char_P),A__questionmark_charuPuallocutableu0_537) )
      & ( valid_root_char_P(A__questionmark_v_1_295,A__questionmark_au0_535,A__questionmark_bu0_536,A__questionmark_v_0_296)
...
tff(formula_176,axiom,
    ! [A__questionmark_pu0_542: c_unsorted,A__questionmark_au0_543: $int,A__questionmark_bu0_544: $int,A__questionmark_Tuallocutableu0_545: c_unsorted] :
    ? [A__questionmark_v_1_299: c_sorted,A__questionmark_v_0_300: c_sorted] :
      ( ( A__questionmark_v_1_299 = c_sort(pointer('T'),A__questionmark_pu0_542) )
      & ( A__questionmark_v_0_300 = c_sort(alloc_table('T'),A__questionmark_Tuallocutableu0_545) )
      & ( valid_struct_T(A__questionmark_v_1_299,A__questionmark_au0_543,A__questionmark_bu0_544,A__questionmark_v_0_300)
...
tff(formula_177,axiom,
    ! [A__questionmark_pu0_546: c_unsorted,A__questionmark_au0_547: $int,A__questionmark_bu0_548: $int,A__questionmark_charuPuallocutableu0_549: c_unsorted] :
    ? [A__questionmark_v_1_301: c_sorted,A__questionmark_v_0_302: c_sorted] :
      ( ( A__questionmark_v_1_301 = c_sort(pointer(char_P),A__questionmark_pu0_546) )
      & ( A__questionmark_v_0_302 = c_sort(alloc_table(char_P),A__questionmark_charuPuallocutableu0_549) )
      & ( valid_struct_char_P(A__questionmark_v_1_301,A__questionmark_au0_547,A__questionmark_bu0_548,A__questionmark_v_0_302)
...
tff(formula_184,axiom,
    ~ ! [A__questionmark_p: c_unsorted,A__questionmark_T_p_1_alloc_table: c_unsorted] :
      ? [A__questionmark_v_0_310: c_sorted,A__questionmark_v_1_311: c_sorted] :
        ( ( A__questionmark_v_0_310 = c_sort(alloc_table('T'),A__questionmark_T_p_1_alloc_table) )
        & ( A__questionmark_v_1_311 = c_sort(pointer('T'),A__questionmark_p) )
        & ? [A__questionmark_v_2_312: $int] :
            ( ( A__questionmark_v_2_312 = offset_max(A__questionmark_v_0_310,A__questionmark_v_1_311) )
            & ( ( $lesseq(offset_min(A__questionmark_v_0_310,A__questionmark_v_1_311),0)
                & $greatereq(A__questionmark_v_2_312,0) )
             => $lesseq(0,A__questionmark_v_2_312) ) ) ) ).
