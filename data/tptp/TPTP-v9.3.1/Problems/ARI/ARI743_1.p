%------------------------------------------------------------------------------
% File     : ARI743_1 : TPTP v9.3.1. Released v7.0.0.
% Domain   : Arithmetic
% Problem  : Square root of 1.0
% Version  : Especial.
% English  :

% Refs     : [Pas16] Paskevich (2016), Email to Geoff Sutcliffe
% Source   : [Pas16]
% Names    : real-SquareTest-Sqrt_one.p [Pas16]

% Status   : Theorem
% Rating   : 0.20 v9.3.0, 0.25 v7.5.0, 0.30 v7.4.0, 0.25 v7.3.0, 0.33 v7.0.0
...
%            Number arithmetic     :   32 (   9 atm;   4 fun;  11 num;   8 var)
%            Number of types       :    1 (   0 usr;   1 ari;   0 dat;   0 cdt)
%            Number of type conns  :    2 (   2   >;   0   *;   0   +;   0  <<)
%            Number of predicates  :    2 (   0 usr;   0 prp; 2-2 aty)
%            Number of functors    :    5 (   2 usr;   2 con; 0-2 aty)
