%------------------------------------------------------------------------------
% File     : ARI432_1 : TPTP v9.3.1. Released v5.0.0.
% Domain   : Arithmetic
% Problem  : Real: Difference 16.05 and only 4.0 is 12.05
% Version  : Especial.
% English  :
...
% Comments :
%------------------------------------------------------------------------------
tff(real_difference_problem_8,conjecture,
    ! [X: $real] :
      ( ( $difference(16.05,X) = 12.05 )
     => ( X = 4.0 ) ) ).
