%------------------------------------------------------------------------------
% File     : ARI752_1 : TPTP v9.3.1. Released v7.0.0.
...
% Refs     :
% Source   : [SMTL]
% Names    : aviation/consts_why.p [SMTL]

% Status   : Unsatisfiable
% Rating   : 0.00 v7.0.0
% Syntax   : Number of formulae    :  311 (  19 unt; 141 typ;   0 def)
%            Number of atoms       :  653 ( 440 equ)
%            Maximal formula atoms :   14 (   3 avg)
%            Number of connectives :  504 (  21   ~;   8   |; 348   &)
%                                         (  59 <=>;  68  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   32 (   9 avg)
%            Maximal term depth    :    6 (   1 avg)
%            Number arithmetic     :  388 (  97 atm;  37 fun;  56 num; 198 var)
...
%            Number of functors    :  117 ( 104 usr;  25 con; 0-5 aty)
%            Number of variables   :  816 ( 520   !; 296   ?; 816   :)
...
tff(formula_170,axiom,
    ~ ( ( c_Boolean_true = c_Boolean_true )
     => ! [A__questionmark_result: c_unsorted] :
          ( ( integer_of_int32(c_sort(int32,A__questionmark_result)) = 18 )
         => ! [A__questionmark_smtlib____retres: c_unsorted] :
              ( ( c_sort(int32,A__questionmark_smtlib____retres) = c_sort(int32,A__questionmark_result) )
             => ! [A__questionmark_return: c_unsorted] :
                ? [A__questionmark_v_0_288: c_sorted] :
                  ( ( A__questionmark_v_0_288 = c_sort(int32,A__questionmark_return) )
                  & ( ( A__questionmark_v_0_288 = c_sort(int32,A__questionmark_smtlib____retres) )
                   => ( integer_of_int32(A__questionmark_v_0_288) = 18 ) ) ) ) ) ) ).
