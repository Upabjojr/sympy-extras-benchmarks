%------------------------------------------------------------------------------
% File     : ARI545_1 : TPTP v9.3.1. Released v5.0.0.
% Domain   : Arithmetic
% Problem  : Integer: Something plus iteself less than -13
% Version  : Especial.
% English  :
...
% Comments :
%------------------------------------------------------------------------------
tff(int_combined_problem_9,conjecture,
    ? [X: $int] : $less($sum(X,X),-13) ).
